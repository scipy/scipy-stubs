...
assert_type(root(_fn_f_n_1, _x0_f).status, int)
assert_type(root(_fn_f_n_1, _x0_f).nit, int)
assert_type(root(_fn_f_n_1, _x0_f).fjac, onp.Array2D[np.float64])
assert_type(root(_fn_f_n_1, _x0_f).qtf, onp.Array1D[np.float64])
assert_type(root(_fn_f_n_1, _x0_f).r, onp.Array1D[np.float64])
assert_type(root(_fn_f_n_1, _x0_f).cov_x, onp.Array2D[np.float64] | None)
assert_type(root(_fn_f_n_1, _x0_f).ipvt, onp.Array1D[np.int32])
