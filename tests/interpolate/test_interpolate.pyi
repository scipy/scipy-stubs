...
assert_type(interp1d(_f64_1d, _f32_1d), interp1d[np.float64])
assert_type(interp1d(_f64_1d, _f32_1d, "nearest")(0.5), onp.ArrayND[np.float32])
assert_type(interp1d(_f64_1d, _f64_1d), interp1d[np.float64])
assert_type(interp1d(_f64_1d, _f80_1d), interp1d[np.float128])
assert_type(interp1d(_f64_1d, _c64_1d), interp1d[np.complex128])
