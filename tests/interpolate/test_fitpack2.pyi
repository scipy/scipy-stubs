...
assert_type(sbs(x, y), onp.Array2D[np.float64])
assert_type(sbs(x, y, grid=True), onp.Array2D[np.float64])
assert_type(sbs(x, y, grid=False), onp.Array1D[np.float64])
assert_type(sbs(1.0, 0.5), onp.Array2D[np.float64])
assert_type(sbs(1.0, 0.5, grid=False), onp.Array0D[np.float64])
assert_type(sbs(x, 0.5, grid=False), onp.Array1D[np.float64])
assert_type(sbs(1.0, y, grid=False), onp.Array1D[np.float64])
assert_type(sbs(x2d, x2d, grid=False), onp.ArrayND[np.float64])
assert_type(sbs.ev(x, y), onp.ArrayND[np.float64])
...
assert_type(lbs(x, y), onp.Array2D[np.float64])
...
assert_type(rbs(x, y), onp.Array2D[np.float64])
...
bvs: BivariateSpline
assert_type(bvs(x, y), onp.Array2D[np.float64])
assert_type(bvs(x, y, grid=True), onp.Array2D[np.float64])
assert_type(bvs(x, y, grid=False), onp.Array1D[np.float64])
assert_type(bvs.ev(x, y), onp.ArrayND[np.float64])
...
assert_type(ssbs(x, y), onp.ArrayND[np.float64])
assert_type(ssbs.ev(x, y), onp.ArrayND[np.float64])

# LSQSphereBivariateSpline

lsbs = LSQSphereBivariateSpline(x, y, y, x, x)
assert_type(lsbs, LSQSphereBivariateSpline)
assert_type(lsbs(x, y), onp.ArrayND[np.float64])
assert_type(lsbs.ev(x, y), onp.ArrayND[np.float64])

# RectSphereBivariateSpline

rsbs = RectSphereBivariateSpline(x, y, x2d)
assert_type(rsbs, RectSphereBivariateSpline)
assert_type(rsbs(x, y), onp.ArrayND[np.float64])
assert_type(rsbs.ev(x, y), onp.ArrayND[np.float64])
