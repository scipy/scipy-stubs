...
assert_type(sparse.diags_array(dense_1d, dtype=np.longdouble), sparse.dia_array[np.longdouble])
assert_type(sparse.diags_array(dense_2d, dtype=np.longdouble), sparse.dia_array[np.longdouble])
...
assert_type(sparse.diags(dense_1d, int_list, (5, 5), "lil"), sparse.lil_matrix[ScalarType])
assert_type(sparse.diags(dense_1d, int_list, (5, 5), "bsr"), sparse.bsr_matrix[ScalarType])
assert_type(sparse.diags(dense_1d, int_list, (5, 5), "coo"), sparse.coo_matrix[ScalarType])
assert_type(sparse.diags(dense_1d, int_list, (5, 5), "csc"), sparse.csc_matrix[ScalarType])
assert_type(sparse.diags(dense_1d, int_list, (5, 5), "csr"), sparse.csr_matrix[ScalarType])
assert_type(sparse.diags(dense_1d, int_list, (5, 5), "dia"), sparse.dia_matrix[ScalarType])
assert_type(sparse.diags(dense_1d, int_list, (5, 5), "dok"), sparse.dok_matrix[ScalarType])
assert_type(sparse.diags(dense_1d, int_list, (5, 5), "lil"), sparse.lil_matrix[ScalarType])
