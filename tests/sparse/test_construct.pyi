...
# https://github.com/facebook/pyrefly/issues/2527
...
assert_type(sparse.random(4, 2, format="bsr"), sparse.bsr_matrix[np.float64])
assert_type(sparse.random(4, 2, format="coo"), sparse.coo_matrix[np.float64])
assert_type(sparse.random(4, 2, format="csc"), sparse.csc_matrix[np.float64])
assert_type(sparse.random(4, 2, format="csr"), sparse.csr_matrix[np.float64])
assert_type(sparse.random(4, 2, format="dia"), sparse.dia_matrix[np.float64])
assert_type(sparse.random(4, 2, format="dok"), sparse.dok_matrix[np.float64])
assert_type(sparse.random(4, 2, format="lil"), sparse.lil_matrix[np.float64])
assert_type(sparse.random(4, 2, format="csr", dtype=sctype), sparse.csr_matrix[ScalarType])
assert_type(sparse.random(4, 2, format="lil", dtype=complex), sparse.lil_matrix[np.complex128])
assert_type(sparse.random(4, 2, format="dia", dtype="int"), sparse.dia_matrix)
...
assert_type(sparse.rand(4, 2, format="bsr"), sparse.bsr_matrix[np.float64])
assert_type(sparse.rand(4, 2, format="coo"), sparse.coo_matrix[np.float64])
assert_type(sparse.rand(4, 2, format="csc"), sparse.csc_matrix[np.float64])
assert_type(sparse.rand(4, 2, format="csr"), sparse.csr_matrix[np.float64])
assert_type(sparse.rand(4, 2, format="dia"), sparse.dia_matrix[np.float64])
assert_type(sparse.rand(4, 2, format="dok"), sparse.dok_matrix[np.float64])
assert_type(sparse.rand(4, 2, format="lil"), sparse.lil_matrix[np.float64])
assert_type(sparse.rand(4, 2, format="csr", dtype=sctype), sparse.csr_matrix[ScalarType])
assert_type(sparse.rand(4, 2, format="lil", dtype=complex), sparse.lil_matrix[np.complex128])
