...
assert_type(dok_array(seq_bool), dok_array[np.bool, tuple[int]])
...
assert_type(dok_array(seq_seq_bool), dok_array[np.bool, tuple[int, int]])
...
assert_type(dok_matrix(seq_seq_bool), dok_matrix[np.bool])
