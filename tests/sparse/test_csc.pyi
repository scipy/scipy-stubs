...
assert_type(csc_matrix(data2, dtype=bool), csc_matrix[np.bool])
...
assert_type(csc_matrix(shape2, dtype=bool), csc_matrix[np.bool])
...
assert_type(csc_matrix(csc_spec2, dtype=bool), csc_matrix[np.bool])
...
assert_type(csc_matrix(csc_spec3, dtype=bool), csc_matrix[np.bool])
...
assert_type(csc_array(data2, dtype=bool), csc_array[np.bool])
...
assert_type(csc_array(shape2, dtype=bool), csc_array[np.bool])
...
assert_type(csc_array(csc_spec2, dtype=bool), csc_array[np.bool])
...
assert_type(csc_array(csc_spec3, dtype=bool), csc_array[np.bool])
