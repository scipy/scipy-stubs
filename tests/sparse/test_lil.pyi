...
assert_type(lil_matrix(data2, dtype=bool), lil_matrix[np.bool])
...
assert_type(lil_matrix(shape2, dtype=bool), lil_matrix[np.bool])
...
assert_type(lil_array(data2, dtype=bool), lil_array[np.bool])
...
assert_type(lil_array(shape2, dtype=bool), lil_array[np.bool])
