# type-tests for `sparse/csgraph/_matching.pyi`
...
assert_type(min_weight_full_bipartite_matching(_csr_arr), tuple[onp.Array1D[np.int32 | np.intp], onp.Array1D[np.int32 | np.intp]])
