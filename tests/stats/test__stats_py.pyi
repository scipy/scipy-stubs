...
assert_type(tmean(_i64_2d), onp.Array1D[np.float64])
...
assert_type(tmean(_i64_1d, axis=None), np.float64)
...
assert_type(tmean(_i64_2d, axis=None), np.float64)
...
assert_type(tmean(_i64_nd, axis=None), np.float64)
