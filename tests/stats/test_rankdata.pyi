...
assert_type(rankdata(_f16_1d), onp.Array1D[np.float16])
...
assert_type(rankdata(_f16_2d), onp.Array1D[np.float16])
...
assert_type(rankdata(_f16_3d), onp.Array1D[np.float16])
assert_type(rankdata(_f64_3d), onp.Array1D[np.float64])

assert_type(rankdata(_i8_nd), onp.Array1D[np.float64])
assert_type(rankdata(_f16_nd), onp.Array1D[np.float16])
...
assert_type(rankdata(_f16_1d, axis=0), onp.Array1D[np.float16])
...
assert_type(rankdata(_f16_2d, axis=0), onp.Array2D[np.float16])
...
assert_type(rankdata(_f16_3d, axis=0), onp.Array3D[np.float16])
assert_type(rankdata(_f64_3d, axis=0), onp.Array3D[np.float64])

assert_type(rankdata(_i8_nd, axis=0), onp.ArrayND[np.float64])  # pyrefly:ignore[assert-type]
assert_type(rankdata(_f64_nd, axis=0), onp.ArrayND[np.float64])  # pyrefly:ignore[assert-type]
