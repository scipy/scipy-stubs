...
assert_type(sem(f32_1d), np.float32)
assert_type(sem(f64_1d), np.float64)
assert_type(sem(c64_1d), np.float32)
...
assert_type(sem(f32_2d), onp.ArrayND[np.float32])
...
assert_type(sem(f32_1d, axis=None), np.float32)
assert_type(sem(f64_1d, axis=None), np.float64)
assert_type(sem(c64_1d, axis=None), np.float32)
...
assert_type(sem(f32_2d, axis=None), np.float32)
assert_type(sem(f64_2d, axis=None), np.float64)
assert_type(sem(c64_2d, axis=None), np.float32)
...
assert_type(sem(f32_1d, keepdims=True), onp.ArrayND[np.float32])
assert_type(sem(f64_1d, keepdims=True), onp.ArrayND[np.float64])
assert_type(sem(c64_1d, keepdims=True), onp.ArrayND[np.float32])
