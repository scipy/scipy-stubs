...
assert_type(quantile(_f32_1d, np.float32(0.5)), np.float32)
assert_type(quantile(_f32_1d, np.float64(0.5)), np.float64)
assert_type(quantile(_f32_2d, np.float32(0.5), axis=1), onp.Array1D[np.float32])
assert_type(quantile(_f32_2d, np.float64(0.5), axis=1), onp.Array1D[np.float64])
assert_type(quantile(_f32_1d, 0.5, method="inverted_cdf", weights=_f16_1d), np.float32)
assert_type(quantile(_f32_1d, 0.5, method="inverted_cdf", weights=_f32_1d), np.float32)
assert_type(quantile(_f32_1d, 0.5, method="inverted_cdf", weights=_f64_1d), np.float64)
assert_type(quantile(_f32_2d, 0.5, method="inverted_cdf", weights=_f64_1d), onp.Array1D[np.float64])
...
assert_type(quantile(_f32_3d, 0.5, axis=None), np.float32)
assert_type(quantile(_f32_2d, 0.5, axis=None, method="inverted_cdf", weights=_f64_1d), np.float64)
...
assert_type(quantile(_f32_1d, 0.5, keepdims=True), onp.ArrayND[np.float32])
assert_type(quantile(_f32_2d, 0.5, keepdims=True), onp.ArrayND[np.float32])
assert_type(quantile(_f32_3d, 0.5, keepdims=True), onp.ArrayND[np.float32])
assert_type(quantile(_f32_2d, 0.5, method="inverted_cdf", keepdims=True, weights=_f64_1d), onp.ArrayND[np.float64])
...
assert_type(quantile(_f32_2d, _f64_1d), onp.ArrayND[np.float64])
assert_type(quantile(_f32_3d, _f64_1d), onp.ArrayND[np.float64])
assert_type(quantile(_f64_1d, _f32_1d), onp.ArrayND[np.float64])
assert_type(quantile(_f64_2d, _f32_1d), onp.ArrayND[np.float64])
assert_type(quantile(_f64_3d, _f32_1d), onp.ArrayND[np.float64])
assert_type(quantile(_f32_1d, _f32_1d), onp.ArrayND[np.float32])
assert_type(quantile(_f32_2d, _f32_1d), onp.ArrayND[np.float32])
assert_type(quantile(_f32_3d, _f32_1d), onp.ArrayND[np.float32])
assert_type(quantile(_f32_1d, _f32_1d, method="inverted_cdf", weights=_f64_1d), onp.ArrayND[np.float64])
...
assert_type(quantile(_f32_1d, _f64_1d, keepdims=True), onp.ArrayND[np.float64])
assert_type(quantile(_f32_2d, _f64_1d, keepdims=True), onp.ArrayND[np.float64])
assert_type(quantile(_f32_3d, _f64_1d, keepdims=True), onp.ArrayND[np.float64])
assert_type(quantile(_f64_1d, _f32_1d, keepdims=True), onp.ArrayND[np.float64])
assert_type(quantile(_f64_2d, _f32_1d, keepdims=True), onp.ArrayND[np.float64])
assert_type(quantile(_f64_3d, _f32_1d, keepdims=True), onp.ArrayND[np.float64])
assert_type(quantile(_f32_1d, _f32_1d, keepdims=True), onp.ArrayND[np.float32])
assert_type(quantile(_f32_2d, _f32_1d, keepdims=True), onp.ArrayND[np.float32])
assert_type(quantile(_f32_3d, _f32_1d, keepdims=True), onp.ArrayND[np.float32])
