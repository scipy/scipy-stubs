...
assert_type(directional_stats(_i16_nd), DirectionalStats[onp.ArrayND[np.float64], np.float64 | onp.ArrayND[np.float64]])  # pyrefly:ignore[assert-type]
...
assert_type(directional_stats(_c64_nd), DirectionalStats[onp.ArrayND[np.complex64], np.float32 | onp.ArrayND[np.float32]])  # pyrefly:ignore[assert-type]
assert_type(directional_stats(_c128_nd), DirectionalStats[onp.ArrayND[np.complex128], np.float64 | onp.ArrayND[np.float64]])  # pyrefly:ignore[assert-type]
