...
# iterate_structure
assert_type(iterate_structure(_b_1d, 1), onp.Array1D[np.bool])
assert_type(iterate_structure(_b_2d, 1), onp.Array2D[np.bool])
assert_type(iterate_structure(_b_nd, 1), onp.ArrayND[np.bool])
assert_type(iterate_structure(_b_1d, 1, origin=0), tuple[onp.Array1D[np.bool], list[int]])
assert_type(iterate_structure(_b_2d, 1, origin=0), tuple[onp.Array2D[np.bool], list[int]])
assert_type(iterate_structure(_b_nd, 1, origin=0), tuple[onp.ArrayND[np.bool], list[int]])
assert_type(iterate_structure(_b_nd, 1, origin=_i32), tuple[onp.ArrayND[np.bool], list[np.int32]])

# generate_binary_structure
assert_type(generate_binary_structure(-3, 1), onp.Array0D[np.bool])
assert_type(generate_binary_structure(-2, 1), onp.Array0D[np.bool])
assert_type(generate_binary_structure(-1, 1), onp.Array0D[np.bool])
assert_type(generate_binary_structure(0, 1), onp.Array0D[np.bool])
assert_type(generate_binary_structure(1, 1), onp.Array1D[np.bool])
assert_type(generate_binary_structure(2, 1), onp.Array2D[np.bool])
assert_type(generate_binary_structure(3, 2), onp.Array3D[np.bool])
assert_type(generate_binary_structure(42, 2), onp.ArrayND[np.bool])

# binary_erosion
assert_type(binary_erosion(_py_i_2d), onp.ArrayND[np.bool])
assert_type(binary_erosion(_py_f_2d), onp.ArrayND[np.bool])
assert_type(binary_erosion(_f64_2d), onp.ArrayND[np.bool])
...
assert_type(binary_dilation(_py_f_2d), onp.ArrayND[np.bool])
assert_type(binary_dilation(_f64_2d), onp.ArrayND[np.bool])
...
assert_type(binary_opening(_py_i_2d), onp.ArrayND[np.bool])
assert_type(binary_opening(_py_f_2d), onp.ArrayND[np.bool])
assert_type(binary_opening(_f64_2d), onp.ArrayND[np.bool])
...
assert_type(binary_closing(_py_i_2d), onp.ArrayND[np.bool])
assert_type(binary_closing(_py_f_2d), onp.ArrayND[np.bool])
assert_type(binary_closing(_f64_2d), onp.ArrayND[np.bool])
...
assert_type(binary_hit_or_miss(_py_i_2d), onp.ArrayND[np.bool])
assert_type(binary_hit_or_miss(_py_f_2d), onp.ArrayND[np.bool])
assert_type(binary_hit_or_miss(_f64_2d), onp.ArrayND[np.bool])
...
assert_type(binary_propagation(_py_i_2d), onp.ArrayND[np.bool])
assert_type(binary_propagation(_py_f_2d), onp.ArrayND[np.bool])
assert_type(binary_propagation(_f64_2d), onp.ArrayND[np.bool])
...
assert_type(grey_erosion(_b_2d), onp.Array2D[np.bool])
assert_type(grey_erosion(_b_nd), onp.ArrayND[np.bool])
...
assert_type(grey_erosion(_py_b_2d), onp.ArrayND[np.bool])
...
assert_type(grey_dilation(_b_1d), onp.Array1D[np.bool])
assert_type(grey_dilation(_b_2d), onp.Array2D[np.bool])
assert_type(grey_dilation(_b_nd), onp.ArrayND[np.bool])
...
assert_type(grey_dilation(_py_b_2d), onp.ArrayND[np.bool])
...
assert_type(grey_opening(_b_2d), onp.Array2D[np.bool])
assert_type(grey_opening(_b_nd), onp.ArrayND[np.bool])
...
assert_type(grey_opening(_py_b_2d), onp.ArrayND[np.bool])
...
assert_type(grey_closing(_b_1d), onp.Array1D[np.bool])
assert_type(grey_closing(_b_2d), onp.Array2D[np.bool])
assert_type(grey_closing(_b_nd), onp.ArrayND[np.bool])
...
assert_type(grey_closing(_py_b_2d), onp.ArrayND[np.bool])
...
assert_type(morphological_gradient(_b_1d), onp.Array1D[np.bool])
assert_type(morphological_gradient(_b_2d), onp.Array2D[np.bool])
assert_type(morphological_gradient(_b_nd), onp.ArrayND[np.bool])
...
assert_type(morphological_gradient(_py_b_2d), onp.ArrayND[np.bool])
...
assert_type(morphological_laplace(_b_1d), onp.Array1D[np.bool])
assert_type(morphological_laplace(_b_2d), onp.Array2D[np.bool])
assert_type(morphological_laplace(_b_nd), onp.ArrayND[np.bool])
...
assert_type(morphological_laplace(_py_b_2d), onp.ArrayND[np.bool])
...
assert_type(white_tophat(_b_1d), onp.Array1D[np.bool])
assert_type(white_tophat(_b_2d), onp.Array2D[np.bool])
assert_type(white_tophat(_b_nd), onp.ArrayND[np.bool])
...
assert_type(white_tophat(_py_b_2d), onp.ArrayND[np.bool])
...
assert_type(black_tophat(_b_1d), onp.Array1D[np.bool])
assert_type(black_tophat(_b_2d), onp.Array2D[np.bool])
assert_type(black_tophat(_b_nd), onp.ArrayND[np.bool])
...
assert_type(black_tophat(_py_b_2d), onp.ArrayND[np.bool])
