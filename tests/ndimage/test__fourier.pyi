...
from scipy.ndimage import fourier_ellipsoid, fourier_gaussian, fourier_shift, fourier_uniform
...
fourier_gaussian(f16_nd, 4)  # type:ignore[arg-type] # pyright:ignore[reportArgumentType, reportCallIssue] # pyrefly:ignore[no-matching-overload]
...
fourier_gaussian(f16_nd, 4, output=output_array)  # type:ignore[arg-type] # pyright:ignore[reportArgumentType, reportCallIssue] # pyrefly:ignore[no-matching-overload]
...
fourier_gaussian(f16_nd, 4, output=output_sctype)  # type:ignore[arg-type] # pyright:ignore[reportArgumentType, reportCallIssue] # pyrefly:ignore[no-matching-overload]
...
assert_type(fourier_uniform(f64_nd, 4), onp.ArrayND[np.float64])
assert_type(fourier_uniform(f32_nd, 4), onp.ArrayND[np.float32])
assert_type(fourier_uniform(c64_nd, 4), onp.ArrayND[np.complex64])
assert_type(fourier_uniform(c128_nd, 4), onp.ArrayND[np.complex128])
assert_type(fourier_uniform(f64_nd, 4, output=output_array), _OutputArray)
assert_type(fourier_uniform(f64_nd, 4, output=output_sctype), _OutputArrayND)

###
# `fourier_ellipsoid`

assert_type(fourier_ellipsoid(f64_nd, 4), onp.ArrayND[np.float64])
assert_type(fourier_ellipsoid(f32_nd, 4), onp.ArrayND[np.float32])
assert_type(fourier_ellipsoid(c64_nd, 4), onp.ArrayND[np.complex64])
assert_type(fourier_ellipsoid(c128_nd, 4), onp.ArrayND[np.complex128])
assert_type(fourier_ellipsoid(f64_nd, 4, output=output_array), _OutputArray)
assert_type(fourier_ellipsoid(f64_nd, 4, output=output_sctype), _OutputArrayND)
...
fourier_shift(f16_nd, 4)  # type:ignore[arg-type] # pyright:ignore[reportArgumentType, reportCallIssue] # pyrefly:ignore[no-matching-overload]
...
fourier_shift(f16_nd, 4, output=output_array)  # type:ignore[arg-type] # pyright:ignore[reportArgumentType, reportCallIssue] # pyrefly:ignore[no-matching-overload]
...
fourier_shift(f16_nd, 4, output=output_sctype)  # type:ignore[arg-type] # pyright:ignore[reportArgumentType, reportCallIssue] # pyrefly:ignore[no-matching-overload]
