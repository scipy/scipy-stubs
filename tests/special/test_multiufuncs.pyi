...
type _Float1_D = onp.ArrayND[np.float64, onp.AtLeast1D[Any]]
type _Float2_D = onp.ArrayND[np.float64, onp.AtLeast2D[Any]]
type _Float3_D = onp.ArrayND[np.float64, onp.AtLeast3D[Any]]
type _Complex0D = onp.Array0D[np.complex128]
type _Complex2D = onp.Array2D[np.complex128]
type _Complex1_D = onp.ArrayND[np.complex128, onp.AtLeast1D[Any]]
type _Complex3_D = onp.ArrayND[np.complex128, onp.AtLeast3D[Any]]
...
assert_type(legendre_p(1, np.float32(1.0)), onp.Array1D[np.float32])
...
assert_type(legendre_p_all(n=3, z=np.float32(1.0)), onp.Array2D[np.float32])
assert_type(legendre_p_all(3, np.complex64(1j)), onp.Array2D[np.complex64])
...
assert_type(assoc_legendre_p(n=3, m=2, z=np.float32(1.0)), onp.ArrayND[np.float32, onp.AtLeast1D[Any]])
assert_type(assoc_legendre_p(3, 2, np.complex64(1j)), onp.ArrayND[np.complex64, onp.AtLeast1D[Any]])
