...
assert_type(log_softmax(py_f_0d), np.float64)
assert_type(log_softmax(py_c_0d), np.complex128)
assert_type(log_softmax(f16_0d), np.float16)
assert_type(log_softmax(c64_0d), np.complex64)

assert_type(log_softmax(py_f_1d), onp.ArrayND[np.float64])
assert_type(log_softmax(py_c_1d), onp.ArrayND[np.complex128])
assert_type(log_softmax(f16_1d), np.ndarray[tuple[int], np.dtype[np.float16]])
assert_type(log_softmax(c64_1d), np.ndarray[tuple[int], np.dtype[np.complex64]])
