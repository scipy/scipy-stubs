...
assert_type(solve_circulant(f80_1d, f80_1d), onp.ArrayND[npc.floating])
assert_type(solve_circulant(f80_1d, f80_2d), onp.ArrayND[npc.floating])
...
assert_type(solve_circulant(c160_1d, c160_1d), onp.ArrayND[npc.complexfloating])
assert_type(solve_circulant(c160_1d, c160_2d), onp.ArrayND[npc.complexfloating])
