...
assert_type(wiener(_f80_1d), onp.ArrayND[np.longdouble])
assert_type(wiener(_c128_1d), onp.ArrayND[np.complex128])
assert_type(wiener(_c160_1d), onp.ArrayND[np.clongdouble])
...
assert_type(hilbert(_f80_1d), onp.Array1D[np.clongdouble])
...
assert_type(hilbert(_f80_2d), onp.Array2D[np.clongdouble])
...
assert_type(hilbert(_f80_nd), onp.ArrayND[np.clongdouble])  # pyrefly:ignore[assert-type]
...
assert_type(hilbert2(_f80_2d), onp.Array2D[np.clongdouble])
assert_type(hilbert2(_f_2d), onp.Array2D[np.complex128 | Any])
...
assert_type(envelope(_c64_1d, residual="all"), onp.Array2D[np.complex64])
assert_type(envelope(_c128_2d, residual="all"), onp.Array3D[np.complex128])
assert_type(envelope(_f16_1d, residual=None), onp.Array1D[np.float32])
assert_type(envelope(_f16_2d, residual=None), onp.Array2D[np.float32])
assert_type(envelope(_f32_1d, residual=None), onp.Array1D[np.float32])
assert_type(envelope(_f64_1d, residual=None), onp.Array1D[np.float64])
assert_type(envelope(_f64_2d, residual=None), onp.Array2D[np.float64])
assert_type(envelope(_f80_1d, residual=None), onp.Array1D[npc.floating80])
assert_type(envelope(_c64_1d, residual=None), onp.Array1D[np.float32])
assert_type(envelope(_c64_2d, residual=None), onp.Array2D[np.float32])
