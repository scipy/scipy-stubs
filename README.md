...
| `Akima1DInterpolator[S: (int, ...)]`                | `>=1.18.0.1`  | `>=1.18.1` | [docs](https://docs.scipy.org/doc/scipy/reference/generated/scipy.interpolate.Akima1DInterpolator.html)        |
...
| `PchipInterpolator[S: (int, ...)]`                  | `>=1.18.0.1`  | `>=1.18.1` | [docs](https://docs.scipy.org/doc/scipy/reference/generated/scipy.interpolate.PchipInterpolator.html)          |
...
| `gaussian_kde[T: number \| bool]`                                              | `>=1.17.0.2`  | `>=1.18` | [docs](https://docs.scipy.org/doc/scipy/reference/generated/scipy.stats.gaussian_kde.html)                   |
