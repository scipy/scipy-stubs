...
@deprecated("will be removed in SciPy v2.0.0")
def besselap(N: object, norm: object = "phase") -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
def iirnotch(w0: object, Q: object, fs: object = 2.0) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
def iirpeak(w0: object, Q: object, fs: object = 2.0) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
def iircomb(w0: object, Q: object, ftype: object = "notch", fs: object = 2.0, *, pass_zero: object = False) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
def gammatone(freq: object, ftype: object, order: object = None, numtaps: object = None, fs: object = None) -> object: ...
