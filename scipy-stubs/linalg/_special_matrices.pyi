...
_ScalarT = TypeVar("_ScalarT", bound=np.generic, default=np.bool_ | npc.number | np.object_)
_NumberT = TypeVar("_NumberT", bound=np.generic, default=npc.number | np.object_)
...
@overload
def convolution_matrix(c: onp.ArrayND[_ScalarT, _JustAnyShape], n: int, mode: _ConvMode = "full") -> onp.ArrayND[_ScalarT]: ...
@overload
def convolution_matrix(c: onp.ToArrayStrict1D[_ScalarT, _ScalarT], n: int, mode: _ConvMode = "full") -> onp.Array2D[_ScalarT]: ...
@overload
def convolution_matrix(c: onp.ToArrayStrict2D[_ScalarT, _ScalarT], n: int, mode: _ConvMode = "full") -> onp.Array3D[_ScalarT]: ...
@overload
def convolution_matrix(c: onp.ToArrayND[_ScalarT, _ScalarT], n: int, mode: _ConvMode = "full") -> onp.ArrayND[_ScalarT]: ...
@overload
def convolution_matrix(c: list[bool], n: int, mode: _ConvMode = "full") -> _Bool2D: ...  # type: ignore[overload-overlap]
@overload
def convolution_matrix(c: list[int], n: int, mode: _ConvMode = "full") -> _Int2D: ...
@overload
def convolution_matrix(c: list[float], n: int, mode: _ConvMode = "full") -> _Float2D: ...
@overload
def convolution_matrix(c: list[complex], n: int, mode: _ConvMode = "full") -> _Complex2D: ...
@overload
def convolution_matrix(c: Sequence[list[bool]], n: int, mode: _ConvMode = "full") -> _Bool3D: ...  # type: ignore[overload-overlap]
@overload
def convolution_matrix(c: Sequence[list[int]], n: int, mode: _ConvMode = "full") -> _Int3D: ...
@overload
def convolution_matrix(c: Sequence[list[float]], n: int, mode: _ConvMode = "full") -> _Float3D: ...
@overload
def convolution_matrix(c: Sequence[list[complex]], n: int, mode: _ConvMode = "full") -> _Complex3D: ...
@overload
def convolution_matrix(c: onp.ToJustBoolND, n: int, mode: _ConvMode = "full") -> _BoolND: ...
@overload
def convolution_matrix(c: onp.ToJustInt64_ND, n: int, mode: _ConvMode = "full") -> _IntND: ...
@overload
def convolution_matrix(c: onp.ToJustFloat64_ND, n: int, mode: _ConvMode = "full") -> _FloatND: ...
@overload
def convolution_matrix(c: onp.ToJustComplex128_ND, n: int, mode: _ConvMode = "full") -> _ComplexND: ...

#
@overload
def companion(c: onp.ArrayND[_NumberT, _JustAnyShape]) -> onp.ArrayND[_NumberT]: ...
@overload
def companion(c: onp.ToArrayStrict1D[_NumberT, _NumberT]) -> onp.Array2D[_NumberT]: ...
@overload
def companion(c: onp.ToArrayStrict2D[_NumberT, _NumberT]) -> onp.Array3D[_NumberT]: ...
@overload
def companion(c: onp.ToArrayND[_NumberT, _NumberT]) -> onp.ArrayND[_NumberT]: ...
@overload
def companion(c: list[int]) -> _Int2D: ...
@overload
def companion(c: list[float]) -> _Float2D: ...
@overload
def companion(c: list[complex]) -> _Complex2D: ...
@overload
def companion(c: Sequence[list[int]]) -> _Int3D: ...
@overload
def companion(c: Sequence[list[float]]) -> _Float3D: ...
@overload
def companion(c: Sequence[list[complex]]) -> _Complex3D: ...
@overload
def companion(c: onp.ToJustInt64_ND) -> _IntND: ...
@overload
def companion(c: onp.ToJustFloat64_ND) -> _FloatND: ...
@overload
def companion(c: onp.ToJustComplex128_ND) -> _ComplexND: ...
