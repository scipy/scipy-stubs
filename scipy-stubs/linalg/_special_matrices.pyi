...
# keep in sync with fiedler
@overload
def companion(a: onp.ArrayND[_NumberT, _JustAnyShape]) -> onp.ArrayND[_NumberT]: ...
@overload
def companion(a: onp.ToArrayStrict1D[_NumberT, _NumberT]) -> onp.Array2D[_NumberT]: ...
@overload
def companion(a: onp.ToArrayStrict2D[_NumberT, _NumberT]) -> onp.Array3D[_NumberT]: ...
@overload
def companion(a: onp.ToArrayND[_NumberT, _NumberT]) -> onp.ArrayND[_NumberT]: ...
@overload
def companion(a: list[int]) -> _Int2D: ...
@overload
def companion(a: list[float]) -> _Float2D: ...
@overload
def companion(a: list[complex]) -> _Complex2D: ...
@overload
def companion(a: Sequence[list[int]]) -> _Int3D: ...
@overload
def companion(a: Sequence[list[float]]) -> _Float3D: ...
@overload
def companion(a: Sequence[list[complex]]) -> _Complex3D: ...
@overload
def companion(a: onp.ToJustInt64_ND) -> _IntND: ...
@overload
def companion(a: onp.ToJustFloat64_ND) -> _FloatND: ...
@overload
def companion(a: onp.ToJustComplex128_ND) -> _ComplexND: ...
