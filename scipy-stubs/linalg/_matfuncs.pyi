...
@overload  # disp: False
def logm(A: onp.ToComplex2D, disp: Falsy) -> tuple[_Inexact2D, float | int | bool]: ...
...
@overload  # complex | float | int | bool, disp: True = ...
def funm(A: onp.ToComplex2D, func: _ComplexFunc, disp: Truthy = True) -> _Complex2D: ...
@overload  # complex | float | int | bool, disp: False
