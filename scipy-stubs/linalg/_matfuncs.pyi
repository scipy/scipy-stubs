...
) -> onp.ArrayND[IntT, ShapeT] | onp.ArrayND[np.float64, ShapeT]: ...
...
) -> onp.ArrayND[np.float64, ShapeT] | onp.ArrayND[np.complex128, ShapeT]: ...
...
) -> onp.ArrayND[np.bool, ShapeT] | onp.ArrayND[np.float64, ShapeT]: ...
...
) -> onp.ArrayND[np.longdouble, ShapeT] | onp.ArrayND[np.clongdouble, ShapeT]: ...
...
def fractional_matrix_power(
    A: Sequence[Sequence[float]], t: onp.ToJustFloat
...
@overload  # Nd ~f32
def sqrtm[ShapeT: _AtLeast2D_ish](
    A: onp.ArrayND[npc.floating32, ShapeT],
) -> onp.ArrayND[np.float32, ShapeT] | onp.ArrayND[np.complex64, ShapeT]: ...
...
@deprecated("bool input will no longer be supported in SciPy 2.1")
def sqrtm[ShapeT: _AtLeast2D_ish](
    A: onp.ArrayND[np.bool, ShapeT],
) -> onp.ArrayND[np.float64, ShapeT] | onp.ArrayND[np.complex128, ShapeT]: ...
@overload  # Nd f80
@deprecated("longdouble input will no longer be supported in SciPy 2.1")
def sqrtm[ShapeT: _AtLeast2D_ish](
    A: onp.ArrayND[npc.floating80, ShapeT],
) -> onp.ArrayND[np.float64, ShapeT] | onp.ArrayND[np.complex128, ShapeT]: ...
@overload  # Nd f16
@deprecated("float16 input will no longer be supported in SciPy 2.1")
def sqrtm[ShapeT: _AtLeast2D_ish](
    A: onp.ArrayND[npc.floating16, ShapeT],
) -> onp.ArrayND[np.float32, ShapeT] | onp.ArrayND[np.complex64, ShapeT]: ...
@overload  # Nd c160
@deprecated("clongdouble input will no longer be supported in SciPy 2.1")
def sqrtm[ShapeT: _AtLeast2D_ish](A: onp.ArrayND[npc.complexfloating160, ShapeT]) -> onp.ArrayND[np.complex128, ShapeT]: ...
@overload  # 2d +float
def sqrtm(A: Sequence[Sequence[float]]) -> onp.Array2D[np.float64] | onp.Array2D[np.complex128]: ...
@overload  # 2d ~complex
def sqrtm(A: Sequence[list[complex]]) -> onp.Array2D[np.complex128]: ...
@overload  # 3d +float
def sqrtm(A: Sequence[Sequence[Sequence[float]]]) -> onp.Array3D[np.float64] | onp.Array3D[np.complex128]: ...
@overload  # 3d ~complex
...
@overload  # 2d +float
def logm(A: Sequence[Sequence[float]]) -> onp.Array2D[np.float64] | onp.Array2D[np.complex128]: ...
@overload  # 2d ~complex
def logm(A: Sequence[list[complex]]) -> onp.Array2D[np.complex128]: ...
@overload  # 3d +float
def logm(A: Sequence[Sequence[Sequence[float]]]) -> onp.Array3D[np.float64] | onp.Array3D[np.complex128]: ...
@overload  # 3d ~complex
...
) -> tuple[onp.ArrayND[np.float64, ShapeT] | onp.ArrayND[np.complex128, ShapeT], np.float64]: ...
@overload  # Nd ~f32
def funm[ShapeT: _AtLeast2D_ish](
...
) -> tuple[onp.ArrayND[np.float32, ShapeT] | onp.ArrayND[np.complex64, ShapeT], np.float32]: ...
@overload  # Nd T@(c128|c64)
...
) -> onp.ArrayND[npc.inexact64, ShapeT] | onp.ArrayND[npc.inexact32, ShapeT]: ...
@overload  # 2d +float
def funm(
...
def khatri_rao(a: onp.ToIntND, b: onp.ToIntND) -> onp.ArrayND[npc.integer] | onp.ArrayND[np.float64]: ...
@overload  # Nd +f64, ~f64
