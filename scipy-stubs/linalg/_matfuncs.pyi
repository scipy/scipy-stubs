...
#
@overload  # ?d T, Nd T
def khatri_rao[ScalarT: (np.uint8, np.int32, np.int64, np.float32, np.float64, np.complex64, np.complex128)](
...
@overload  # 2d ~int, 2d ~int
def khatri_rao(a: Sequence[Sequence[int]], b: Sequence[Sequence[int]]) -> onp.Array2D[np.int_]: ...
@overload  # 2d +float, 2d +float
def khatri_rao(a: Sequence[list[float]], b: Sequence[list[float]]) -> onp.Array2D[np.float64]: ...
@overload  # 2d ~complex, 2d ~complex
def khatri_rao(a: Sequence[list[complex]], b: Sequence[list[complex]]) -> onp.Array2D[np.complex128]: ...
@overload  # 3d ~int, 3d ~int
def khatri_rao(a: Sequence[Sequence[Sequence[int]]], b: Sequence[Sequence[Sequence[int]]]) -> onp.Array3D[np.int_]: ...
@overload  # 3d +float, 3d +float
def khatri_rao(a: Sequence[Sequence[list[float]]], b: Sequence[Sequence[list[float]]]) -> onp.Array3D[np.float64]: ...
...
def khatri_rao(a: onp.ToIntND, b: onp.ToIntND) -> onp.ArrayND[np.int_ | Any]: ...
@overload  # Nd +f64, ~f64
...
def khatri_rao(a: onp.ToFloatND, b: onp.ToJustFloatND) -> onp.ArrayND[np.float64 | Any]: ...
@overload  # Nd ~float, +float
def khatri_rao(a: onp.ToJustFloatND, b: onp.ToFloatND) -> onp.ArrayND[np.float64 | Any]: ...
@overload  # Nd +c64, ~c64
...
def khatri_rao(a: onp.ToComplexND, b: onp.ToJustComplexND) -> onp.ArrayND[np.complex128 | Any]: ...
@overload  # Nd ~complex, +complex
def khatri_rao(a: onp.ToJustComplexND, b: onp.ToComplexND) -> onp.ArrayND[np.complex128 | Any]: ...
