...
_NumericND: TypeAlias = onp.ArrayND[np.number[Any]]
...
def fractional_matrix_power(A: onp.ToComplexND, t: onp.ToInt) -> _NumericND: ...
...
@overload  # disp: True = ...
def logm(A: onp.ToComplexND, disp: Truthy = True) -> _InexactND: ...
@overload  # disp: False
...
#
@overload  # real, disp: True = ...
def signm(A: onp.ToFloatND, disp: Truthy = True) -> _FloatND: ...
@overload  # real, disp: False
def signm(A: onp.ToFloatND, disp: Falsy) -> tuple[_FloatND, np.float64]: ...
@overload  # complex, disp: True = ...
def signm(A: onp.ToComplexND, disp: Truthy = True) -> _InexactND: ...
@overload  # complex, disp: False
...
@overload  # real
def khatri_rao(a: onp.ToFloatND, b: onp.ToFloatND) -> _RealND: ...
@overload  # complex
def khatri_rao(a: onp.ToComplexND, b: onp.ToComplexND) -> _NumericND: ...
