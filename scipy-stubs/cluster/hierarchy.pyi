...
#
def optimal_leaf_ordering(Z: onp.ToArray2D, y: onp.ToArrayND, metric: _Metric = "euclidean") -> onp.Array2D[np.float64]: ...
...
#
def inconsistent(Z: onp.ToArray2D, d: int = 2) -> onp.Array2D[np.float64]: ...

#
def from_mlab_linkage(Z: onp.ToArray2D) -> onp.Array2D[np.float64]: ...
def to_mlab_linkage(Z: onp.ToArray2D) -> onp.Array2D[np.float64]: ...
