...
@overload
def lqn(n: onp.ToInt, z: _ToFloatOrND) -> _tuple2[_f8_nd]: ...  # type: ignore[overload-overlap]
@overload
def lqn(n: onp.ToInt, z: onp.ToJustComplex) -> _tuple2[_c8_1d]: ...
@overload
def lqn(n: onp.ToInt, z: _ToJustComplexOrND) -> _tuple2[_c8_nd]: ...  # type: ignore[overload-overlap]
@overload
def lqn(n: onp.ToInt, z: onp.ToComplex) -> _tuple2[_f8_1d] | _tuple2[_c8_1d]: ...
@overload
...
@overload
def lqmn(m: onp.ToFloat, n: onp.ToFloat, z: _ToFloatOrND) -> _tuple2[_f8_nd]: ...  # type: ignore[overload-overlap]
@overload
def lqmn(m: onp.ToFloat, n: onp.ToFloat, z: onp.ToJustComplex) -> _tuple2[_c8_1d]: ...
@overload
def lqmn(m: onp.ToFloat, n: onp.ToFloat, z: _ToJustComplexOrND) -> _tuple2[_c8_nd]: ...  # type: ignore[overload-overlap]
@overload
def lqmn(m: onp.ToFloat, n: onp.ToFloat, z: onp.ToComplex) -> _tuple2[_f8_1d] | _tuple2[_c8_1d]: ...
@overload
...
@overload
@deprecated("`exact=True` is deprecated for non-integer `N` and `k` and will raise an error in SciPy 1.16.0")
def comb(N: onp.ToJustFloat, k: onp.ToFloat, *, exact: Truthy, repetition: op.CanBool = False) -> _f: ...
@overload
def comb(N: onp.ToFloat, k: onp.ToFloat, *, exact: Falsy = False, repetition: op.CanBool = False) -> _f: ...
@overload
def comb(N: _ToFloatOrND, k: onp.ToFloatND, *, exact: Falsy = False, repetition: op.CanBool = False) -> _f_nd: ...
@overload
def comb(N: onp.ToFloatND, k: _ToFloatOrND, *, exact: Falsy = False, repetition: op.CanBool = False) -> _f_nd: ...
@overload
def comb(N: _ToFloatOrND, k: _ToFloatOrND, *, exact: Falsy = False, repetition: op.CanBool = False) -> _f | _f_nd: ...
...
@overload
def perm(N: _ToFloatOrND, k: onp.ToFloatND, exact: Falsy = False) -> _f_nd: ...
@overload
def perm(N: onp.ToFloatND, k: _ToFloatOrND, exact: Falsy = False) -> _f_nd: ...
@overload
def perm(N: _ToFloatOrND, k: _ToFloatOrND, exact: Falsy = False) -> _f | _f_nd: ...
...
@overload
def factorial(n: onp.ToFloatND, exact: Falsy = False, extend: _Extend = "zero") -> _f8_nd: ...
@overload
def factorial(n: onp.ToComplex, exact: Falsy, extend: _ExtendC) -> _fc8: ...
@overload
def factorial(n: onp.ToComplexND, exact: Falsy, extend: _ExtendC) -> _fc8_nd: ...
@overload
def factorial(n: onp.ToComplex, exact: Falsy = False, *, extend: _ExtendC) -> _fc8: ...
@overload
def factorial(n: onp.ToComplexND, exact: Falsy = False, *, extend: _ExtendC) -> _fc8_nd: ...
...
@overload
def factorial2(n: onp.ToIntND, exact: Truthy, extend: _Extend0 = "zero") -> _i_nd: ...
@overload
def factorial2(n: onp.ToFloat, exact: Falsy = False, extend: _Extend = "zero") -> _f8: ...
@overload
def factorial2(n: onp.ToFloatND, exact: Falsy = False, extend: _Extend = "zero") -> _f8_nd: ...
@overload
def factorial2(n: onp.ToComplex, exact: Falsy, extend: _ExtendC) -> _fc8: ...
@overload
def factorial2(n: onp.ToComplexND, exact: Falsy, extend: _ExtendC) -> _fc8_nd: ...
@overload
def factorial2(n: onp.ToComplex, exact: Falsy = False, *, extend: _ExtendC) -> _fc8: ...
@overload
def factorial2(n: onp.ToComplexND, exact: Falsy = False, *, extend: _ExtendC) -> _fc8_nd: ...
...
@overload
def factorialk(n: onp.ToFloatND, k: onp.ToInt, exact: Falsy = False, extend: _Extend = "zero") -> _f8_nd: ...
@overload
def factorialk(n: onp.ToComplex, k: onp.ToInt, exact: Falsy, extend: _ExtendC) -> _fc8: ...
@overload
def factorialk(n: onp.ToComplexND, k: onp.ToInt, exact: Falsy, extend: _ExtendC) -> _fc8_nd: ...
@overload
def factorialk(n: onp.ToComplex, k: onp.ToInt, exact: Falsy = False, *, extend: _ExtendC) -> _fc8: ...
@overload
def factorialk(n: onp.ToComplexND, k: onp.ToInt, exact: Falsy = False, *, extend: _ExtendC) -> _fc8_nd: ...
...
@overload
def stirling2(N: onp.ToIntND, K: _ToIntOrND, *, exact: Truthy) -> onp.ArrayND[np.object_]: ...
@overload
def stirling2(N: onp.ToInt, K: onp.ToInt, *, exact: Falsy = False) -> _f8: ...
@overload
def stirling2(N: _ToIntOrND, K: onp.ToIntND, *, exact: Falsy = False) -> _f8_nd: ...
@overload
def stirling2(N: onp.ToIntND, K: _ToIntOrND, *, exact: Falsy = False) -> _f8_nd: ...
