...
#
@overload
def diric(x: onp.ToFloat, n: onp.ToInt) -> onp.Array0D[np.float64]: ...
@overload
def diric(x: _ToFloatOrND, n: onp.ToIntND) -> onp.ArrayND[np.float64]: ...
@overload
def diric(x: onp.ToFloatND, n: _ToIntOrND) -> onp.ArrayND[np.float64]: ...
