...
class _CApiDict(TypedDict):
    ...
    __pyx_fuse_0ncfdtr: ReadOnly[CapsuleType]
    __pyx_fuse_0ncfdtri: ReadOnly[CapsuleType]
    ...
    __pyx_fuse_0btdtria: ReadOnly[CapsuleType]
    __pyx_fuse_0btdtrib: ReadOnly[CapsuleType]
    __pyx_fuse_0chndtr: ReadOnly[CapsuleType]
    __pyx_fuse_0chndtridf: ReadOnly[CapsuleType]
    __pyx_fuse_0chndtrinc: ReadOnly[CapsuleType]
    __pyx_fuse_0chndtrix: ReadOnly[CapsuleType]
    __pyx_fuse_0fdtr: ReadOnly[CapsuleType]
    __pyx_fuse_0fdtrc: ReadOnly[CapsuleType]
    __pyx_fuse_0fdtri: ReadOnly[CapsuleType]
    __pyx_fuse_0nbdtr: ReadOnly[CapsuleType]
    __pyx_fuse_0nbdtrc: ReadOnly[CapsuleType]
    __pyx_fuse_0nbdtri: ReadOnly[CapsuleType]
    __pyx_fuse_0nctdtr: ReadOnly[CapsuleType]
    __pyx_fuse_0nctdtrit: ReadOnly[CapsuleType]
    ...
    __pyx_fuse_1ncfdtr: ReadOnly[CapsuleType]
    __pyx_fuse_1ncfdtri: ReadOnly[CapsuleType]
    ...
    __pyx_fuse_1btdtria: ReadOnly[CapsuleType]
    __pyx_fuse_1btdtrib: ReadOnly[CapsuleType]
    __pyx_fuse_1chndtr: ReadOnly[CapsuleType]
    __pyx_fuse_1chndtridf: ReadOnly[CapsuleType]
    __pyx_fuse_1chndtrinc: ReadOnly[CapsuleType]
    __pyx_fuse_1chndtrix: ReadOnly[CapsuleType]
    __pyx_fuse_1fdtr: ReadOnly[CapsuleType]
    __pyx_fuse_1fdtrc: ReadOnly[CapsuleType]
    __pyx_fuse_1fdtri: ReadOnly[CapsuleType]
    __pyx_fuse_1nctdtr: ReadOnly[CapsuleType]
    __pyx_fuse_1nctdtrit: ReadOnly[CapsuleType]
    __pyx_fuse_1chdtriv: ReadOnly[CapsuleType]
    __pyx_fuse_1pdtrik: ReadOnly[CapsuleType]
    __pyx_fuse_1powm1: ReadOnly[CapsuleType]
    __pyx_fuse_1stdtr: ReadOnly[CapsuleType]
    __pyx_fuse_1stdtrit: ReadOnly[CapsuleType]
