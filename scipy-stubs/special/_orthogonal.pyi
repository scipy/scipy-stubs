...
# we need this to avoid a false positive on numpy>=2.5  (ffs...)
...
@overload
def roots_chebyt(n: onp.ToInt, mu: onp.ToTrue) -> _PointsWeightsMuConst: ...

#
@overload
def roots_chebyu(n: onp.ToInt, mu: onp.ToFalse = False) -> _PointsWeights: ...
@overload
def roots_chebyu(n: onp.ToInt, mu: onp.ToTrue) -> _PointsWeightsMuConst: ...

#
@overload
def roots_chebyc(n: onp.ToInt, mu: onp.ToFalse = False) -> _PointsWeights: ...
@overload
def roots_chebyc(n: onp.ToInt, mu: onp.ToTrue) -> _PointsWeightsMuConst: ...

#
@overload
def roots_chebys(n: onp.ToInt, mu: onp.ToFalse = False) -> _PointsWeights: ...
@overload
def roots_chebys(n: onp.ToInt, mu: onp.ToTrue) -> _PointsWeightsMuConst: ...

#
@overload
def roots_sh_chebyt(n: onp.ToInt, mu: onp.ToFalse = False) -> _PointsWeights: ...
@overload
def roots_sh_chebyt(n: onp.ToInt, mu: onp.ToTrue) -> _PointsWeightsMuConst: ...
...
@overload
def roots_legendre(n: onp.ToInt, mu: onp.ToTrue) -> _PointsWeightsMuConst: ...

#
@overload
def roots_sh_legendre(n: onp.ToInt, mu: onp.ToFalse = False) -> _PointsWeights: ...
@overload
def roots_sh_legendre(n: onp.ToInt, mu: onp.ToTrue) -> _PointsWeightsMuConst: ...
