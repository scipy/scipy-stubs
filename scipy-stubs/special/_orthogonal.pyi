...
@overload
def roots_jacobi(n: onp.ToInt, alpha: onp.ToFloat, beta: onp.ToFloat, mu: Truthy) -> _PointsWeightsMu: ...
@overload
def roots_sh_jacobi(n: onp.ToInt, p1: onp.ToFloat, q1: onp.ToFloat, mu: Falsy = False) -> _PointsWeights: ...
@overload
def roots_sh_jacobi(n: onp.ToInt, p1: onp.ToFloat, q1: onp.ToFloat, mu: Truthy) -> _PointsWeightsMu: ...
@overload
def roots_genlaguerre(n: onp.ToInt, alpha: onp.ToFloat, mu: Falsy = False) -> _PointsWeights: ...
@overload
def roots_genlaguerre(n: onp.ToInt, alpha: onp.ToFloat, mu: Truthy) -> _PointsWeightsMu: ...
@overload
def roots_laguerre(n: onp.ToInt, mu: Falsy = False) -> _PointsWeights: ...
@overload
def roots_laguerre(n: onp.ToInt, mu: Truthy) -> _PointsWeightsMu: ...
@overload
def roots_hermite(n: onp.ToInt, mu: Falsy = False) -> _PointsWeights: ...
@overload
def roots_hermite(n: onp.ToInt, mu: Truthy) -> _PointsWeightsMu: ...
@overload
def roots_hermitenorm(n: onp.ToInt, mu: Falsy = False) -> _PointsWeights: ...
@overload
def roots_hermitenorm(n: onp.ToInt, mu: Truthy) -> _PointsWeightsMu: ...
@overload
def roots_gegenbauer(n: onp.ToInt, alpha: onp.ToFloat, mu: Falsy = False) -> _PointsWeights: ...
@overload
def roots_gegenbauer(n: onp.ToInt, alpha: onp.ToFloat, mu: Truthy) -> _PointsWeightsMu: ...
@overload
def roots_chebyt(n: onp.ToInt, mu: Falsy = False) -> _PointsWeights: ...
@overload
def roots_chebyt(n: onp.ToInt, mu: Truthy) -> _PointsWeightsMu: ...
@overload
def roots_chebyu(n: onp.ToInt, mu: Falsy = False) -> _PointsWeights: ...
@overload
def roots_chebyu(n: onp.ToInt, mu: Truthy) -> _PointsWeightsMu: ...
@overload
def roots_chebyc(n: onp.ToInt, mu: Falsy = False) -> _PointsWeights: ...
@overload
def roots_chebyc(n: onp.ToInt, mu: Truthy) -> _PointsWeightsMu: ...
@overload
def roots_chebys(n: onp.ToInt, mu: Falsy = False) -> _PointsWeights: ...
@overload
def roots_chebys(n: onp.ToInt, mu: Truthy) -> _PointsWeightsMu: ...
@overload
def roots_sh_chebyt(n: onp.ToInt, mu: Falsy = False) -> _PointsWeights: ...
@overload
def roots_sh_chebyt(n: onp.ToInt, mu: Truthy) -> _PointsWeightsMu: ...
@overload
def roots_sh_chebyu(n: onp.ToInt, mu: Falsy = False) -> _PointsWeights: ...
@overload
def roots_sh_chebyu(n: onp.ToInt, mu: Truthy) -> _PointsWeightsMu: ...
@overload
def roots_legendre(n: onp.ToInt, mu: Falsy = False) -> _PointsWeights: ...
@overload
def roots_legendre(n: onp.ToInt, mu: Truthy) -> _PointsWeightsMu: ...
@overload
def roots_sh_legendre(n: onp.ToInt, mu: Falsy = False) -> _PointsWeights: ...
@overload
def roots_sh_legendre(n: onp.ToInt, mu: Truthy) -> _PointsWeightsMu: ...
