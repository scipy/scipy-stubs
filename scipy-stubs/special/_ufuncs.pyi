...
type _None2 = tuple[None, None]
type _None4 = tuple[None, None, None, None]

type _OutArray = onp.ArrayND[npc.number]
type _Out1[MaybeOutT: _OutArray | None] = tuple[MaybeOutT] | MaybeOutT

type _OneOrMany[T] = T | tuple[T, ...]

# NOTE: The `TypeAliasType` helps with readability of error messages
type _ToBool_D = bool | onp.ToBoolND
...
type _Float_D = _Float | onp.ArrayND[_Float]

type _LFloat = _Float | np.longdouble
type _LFloatND = onp.ArrayND[_LFloat]
type _LFloat_D = _LFloat | _LFloatND

type _Complex = np.complex64 | np.complex128
type _ComplexND = onp.ArrayND[_Complex]
type _Complex_D = _Complex | _ComplexND

type _Inexact = _Float | _Complex
type _InexactND = onp.ArrayND[_Inexact]
type _Inexact_D = _Inexact | _InexactND

type _CoInt = npc.integer | np.bool  # coercible to integer
type _CoFloat = npc.floating | _CoInt  # coercible to floating
type _CoFloat64 = np.float64 | np.float32 | np.float16 | _CoInt  # coercible to float64
type _CoComplex128 = np.complex128 | np.complex64 | _CoFloat64  # coercible to complex128

type _CoIntND = onp.ArrayND[_CoInt]
type _CoFloatND = onp.ArrayND[_CoFloat]
type _CoFloat64ND = onp.ArrayND[_CoFloat64]
type _CoComplex128ND = onp.ArrayND[_CoComplex128]
...
type _SubFloat32 = np.float16 | npc.integer16 | npc.integer8 | np.bool  # -> float32
type _SubFloat64 = npc.integer32 | npc.integer64  # -> float64
type _ToSubFloat32 = bool | _SubFloat32
...
type _ToComplex128 = complex | _CoComplex128
type _ToComplex128ND = _ToND[_CoComplex128, _ToComplex128]
type _ToComplex128_D = _ToComplex128 | _ToComplex128ND

type _Axis = AnyShape | None
type _Indices = _OneOrMany[SupportsIndex | slice | EllipsisType] | onp.ToIntND
...
type _ToDType_l = onp.AnyIntDType
type _ToDType_f = onp.AnyFloat32DType
type _ToDType_d = onp.AnyFloat64DType
type _ToDType_g = onp.AnyLongDoubleDType
type _ToDType_F = onp.AnyComplex64DType
type _ToDType_D = onp.AnyComplex128DType
type _ToDType_fd = _ToDType_f | _ToDType_d
type _ToDType_fdg = _ToDType_fd | _ToDType_g
type _ToDType_FD = _ToDType_F | _ToDType_D
type _ToDType_fdFD = _ToDType_fd | _ToDType_FD
...
type _Tuple6[T] = tuple[T, T, T, T, T, T]
type _Tuple7[T] = tuple[T, T, T, T, T, T, T]

type _ToDTypes_ff = _Tuple2[_ToDType_f]
type _ToDTypes_dd = _Tuple2[_ToDType_d]
type _ToDTypes_gg = _Tuple2[_ToDType_g]
type _ToDTypes_FF = _Tuple2[_ToDType_F]
type _ToDTypes_DD = _Tuple2[_ToDType_D]

type _ToDTypes_fff = tuple[_ToDType_f, _ToDType_f, _ToDType_f]
type _ToDTypes_ldd = tuple[_ToDType_l, _ToDType_d, _ToDType_d]
type _ToDTypes_ddd = tuple[_ToDType_d, _ToDType_d, _ToDType_d]
type _ToDTypes_fFF = tuple[_ToDType_f, _ToDType_F, _ToDType_F]
type _ToDTypes_FFF = tuple[_ToDType_F, _ToDType_F, _ToDType_F]
type _ToDTypes_dDD = tuple[_ToDType_d, _ToDType_D, _ToDType_D]
type _ToDTypes_DDD = tuple[_ToDType_D, _ToDType_D, _ToDType_D]

type _ToDTypes_ffff = tuple[_ToDType_f, _ToDType_f, _ToDType_f, _ToDType_f]
type _ToDTypes_lldd = tuple[_ToDType_l, _ToDType_l, _ToDType_d, _ToDType_d]
type _ToDTypes_lddd = tuple[_ToDType_l, _ToDType_d, _ToDType_d, _ToDType_d]
type _ToDTypes_dldd = tuple[_ToDType_d, _ToDType_l, _ToDType_d, _ToDType_d]
type _ToDTypes_dddd = tuple[_ToDType_d, _ToDType_d, _ToDType_d, _ToDType_d]
type _ToDTypes_ffFF = tuple[_ToDType_f, _ToDType_f, _ToDType_F, _ToDType_F]
type _ToDTypes_FFFF = tuple[_ToDType_F, _ToDType_F, _ToDType_F, _ToDType_F]
type _ToDTypes_ddDD = tuple[_ToDType_d, _ToDType_d, _ToDType_D, _ToDType_D]
type _ToDTypes_DDDD = tuple[_ToDType_D, _ToDType_D, _ToDType_D, _ToDType_D]

type _ToDTypes_fffff = tuple[_ToDType_f, _ToDType_f, _ToDType_f, _ToDType_f, _ToDType_f]
type _ToDTypes_ldddd = tuple[_ToDType_l, _ToDType_d, _ToDType_d, _ToDType_d, _ToDType_d]
type _ToDTypes_ddddd = tuple[_ToDType_d, _ToDType_d, _ToDType_d, _ToDType_d, _ToDType_d]
type _ToDTypes_fffFF = tuple[_ToDType_f, _ToDType_f, _ToDType_f, _ToDType_F, _ToDType_F]
type _ToDTypes_fFFFF = tuple[_ToDType_f, _ToDType_F, _ToDType_F, _ToDType_F, _ToDType_F]
type _ToDTypes_FFFFF = tuple[_ToDType_F, _ToDType_F, _ToDType_F, _ToDType_F, _ToDType_F]
type _ToDTypes_dddDD = tuple[_ToDType_d, _ToDType_d, _ToDType_d, _ToDType_D, _ToDType_D]
...
type _ToDTypes_f6 = _Tuple6[_ToDType_f]
type _ToDTypes_d6 = _Tuple6[_ToDType_d]

type _ToDTypes_f7 = _Tuple7[_ToDType_f]
type _ToDTypes_d7 = _Tuple7[_ToDType_d]
...
@type_check_only
class _Kw21ldf(_KwBase, TypedDict, total=False):
    dtype: _ToDType_fd
    signature: L["ff->f", "ld->d", "dd->d"] | _ToDTypes_fff | _ToDTypes_ldd | _ToDTypes_ddd
...
class _UFunc11f(_UFunc11[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    #
    @overload  # scalar, +f32
    def __call__(self, x: _ToSubFloat32, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]) -> np.float32: ...
    @overload  # scalar, +f64
    def __call__(self, x: _ToSubFloat64, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]) -> np.float64: ...
    @overload  # Nd, +f32
    def __call__(self, x: _ToSubFloat32ND, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]) -> _Float32ND: ...
    @overload  # Nd, +f64
    def __call__(self, x: _ToSubFloat64ND, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]) -> _Float64ND: ...
    @overload  # f32 | f64 (scalar | Nd)
    def __call__[ST: _Float_D](self, x: ST, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]) -> ST: ...
    @overload  # scalar, dtype= | signature=
    def __call__(self, x: _ToSubFloat, /, out: _Out1[None] = None, **kw: Unpack[_Kw11f]) -> _Float: ...
    @overload  # Nd, dtype= | signature=
    def __call__(self, x: onp.ToFloat64_ND, /, out: _Out1[None] = None, **kw: Unpack[_Kw11f]) -> _FloatND: ...
    @overload  # out=<given>
    def __call__[OutT: _OutArray](self, x: _ToFloat64OrND, /, out: _Out1[OutT], **kw: Unpack[_Kw11f]) -> OutT: ...
...
class _UFunc11g(_UFunc11[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload  # out=<given>
    def __call__[OutT: _OutArray](self, x: onp.ToFloat | onp.ToFloatND, /, out: _Out1[OutT], **kw: Unpack[_Kw11g]) -> OutT: ...
    #
    @override
    def at(self, a: _CoFloatND, indices: _Indices, /) -> None: ...

# NOTE: `_UFunc11g` with `d->d` first: only an exact `float32` selects `f->f`, anything narrower promotes to `float64`.
@final
@type_check_only
class _UFunc11dfg(_UFunc11[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    @property
    @override
    def ntypes(self, /) -> L[3]: ...
    @property
    @override
    def types(self, /) -> list[L["d->d", "f->f", "g->g"]]: ...
    #
    @overload  # scalar, +f64
    def __call__(self, x: _ToSubFloat, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]) -> np.float64: ...
    @overload  # Nd, +f64
    def __call__(self, x: _ToSubFloatND, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]) -> _Float64ND: ...
    @overload  # f32 | f64 | g (scalar | Nd)
    def __call__[ST: _LFloat_D](self, x: ST, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]) -> ST: ...
    @overload  # scalar, dtype= | signature=
    def __call__(self, x: _ToSubFloat, /, out: _Out1[None] = None, **kw: Unpack[_Kw11g]) -> _LFloat: ...
...
class _UFunc11c(_UFunc11[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__[OutT: _OutArray](self, x: _ToComplex128_D, /, out: _Out1[OutT], **kw: Unpack[_Kw11c]) -> OutT: ...
    #
    @override
...
class _UFunc11fc(_UFunc11[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__(self, x: op.JustComplex, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]) -> np.complex128: ...
    @overload
    def __call__(self, x: _ToSubComplex, /, out: _Out1[None] = None, **kw: Unpack[_Kw11fc]) -> _Inexact: ...
    @overload
    def __call__[ST: _Inexact_D](self, x: ST, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]) -> ST: ...
    @overload
    def __call__(self, x: onp.ToFloat64_ND, /, out: _Out1[None] = None, **kw: Unpack[_Kw11fc]) -> _FloatND: ...
    @overload
    def __call__(self, x: _ToComplex128ND, /, out: _Out1[None] = None, **kw: Unpack[_Kw11fc]) -> _InexactND: ...
    @overload
    def __call__[OutT: _OutArray](self, x: _ToComplex128_D, /, out: _Out1[OutT], **kw: Unpack[_Kw11fc]) -> OutT: ...
    #
    @override
    def at(self, a: _CoComplex128ND, indices: _Indices, /) -> None: ...
...
class _UFunc12f(_UFunc12[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__[ST: _Float_D](self, x: ST, /, out: _None2 = ..., **kw: Unpack[_KwBase]) -> _Tuple2[ST]: ...
    @overload
    ...
    def __call__[OutT1: _OutArray, OutT2: _OutArray](
        self, x: _ToFloat64OrND, /, out: tuple[OutT1, OutT2], **kw: Unpack[_Kw12f]
    ) -> tuple[OutT1, OutT2]: ...
    @overload
    def __call__[OutT1: _OutArray, OutT2: _OutArray](
        self, x: _ToFloat64OrND, out1: OutT1, out2: OutT2, /, **kw: Unpack[_Kw12f]
    ) -> tuple[OutT1, OutT2]: ...
...
class _UFunc12c(_UFunc12[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__[OutT1: _OutArray, OutT2: _OutArray](
        self, x: _ToFloat64OrND, /, out: tuple[OutT1, OutT2], **kw: Unpack[_Kw12c]
    ) -> tuple[OutT1, OutT2]: ...
    @overload
    def __call__[OutT1: _OutArray, OutT2: _OutArray](
        self, x: _ToFloat64OrND, out1: OutT1, out2: OutT2, /, **kw: Unpack[_Kw12c]
    ) -> tuple[OutT1, OutT2]: ...
...
class _UFunc12fc(_UFunc12[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__[ST: _Inexact_D](self, x: ST, /, out: _None2 = ..., **kw: Unpack[_KwBase]) -> _Tuple2[ST]: ...
    @overload
    ...
    @overload
    def __call__[OutT1: _OutArray, OutT2: _OutArray](
        self, x: _ToComplex128_D, /, out: tuple[OutT1, OutT2], **kw: Unpack[_Kw12fc]
    ) -> tuple[OutT1, OutT2]: ...
    @overload
    def __call__[OutT1: _OutArray, OutT2: _OutArray](
        self, x: _ToComplex128_D, out1: OutT1, out2: OutT2, /, **kw: Unpack[_Kw12fc]
    ) -> tuple[OutT1, OutT2]: ...
...
class _UFunc14f(_UFunc14[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__[ST: _Float_D](self, x: ST, /, out: _None4 = ..., **kw: Unpack[_KwBase]) -> _Tuple4[ST]: ...
    @overload
    def __call__(self, x: onp.ToFloat64_ND, /, out: _None4 = ..., **kw: Unpack[_Kw14f]) -> _Tuple4[_FloatND]: ...
    @overload
    def __call__[OutT1: _OutArray, OutT2: _OutArray, OutT3: _OutArray, OutT4: _OutArray](
        self, x: _ToFloat64OrND, /, out: tuple[OutT1, OutT2, OutT3, OutT4], **kw: Unpack[_Kw14f]
    ) -> tuple[OutT1, OutT2, OutT3, OutT4]: ...
    @overload
    def __call__[OutT1: _OutArray, OutT2: _OutArray, OutT3: _OutArray, OutT4: _OutArray](
        self, x: _ToFloat64OrND, out1: OutT1, out2: OutT2, out3: OutT3, out4: OutT4, /, **kw: Unpack[_Kw14f]
    ) -> tuple[OutT1, OutT2, OutT3, OutT4]: ...
...
class _UFunc14c(_UFunc14[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__[OutT1: _OutArray, OutT2: _OutArray, OutT3: _OutArray, OutT4: _OutArray](
        self, x: _ToFloat64OrND, /, out: tuple[OutT1, OutT2, OutT3, OutT4], **kw: Unpack[_Kw14c]
    ) -> tuple[OutT1, OutT2, OutT3, OutT4]: ...
    @overload
    def __call__[OutT1: _OutArray, OutT2: _OutArray, OutT3: _OutArray, OutT4: _OutArray](
        self, x: _ToFloat64OrND, out1: OutT1, out2: OutT2, out3: OutT3, out4: OutT4, /, **kw: Unpack[_Kw14c]
    ) -> tuple[OutT1, OutT2, OutT3, OutT4]: ...
...
class _UFunc14fc(_UFunc14[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__[ST: _Inexact_D](self, x: ST, /, out: _None4 = ..., **kw: Unpack[_KwBase]) -> _Tuple4[ST]: ...
    @overload
    ...
    @overload
    def __call__[OutT1: _OutArray, OutT2: _OutArray, OutT3: _OutArray, OutT4: _OutArray](
        self, x: _ToComplex128_D, /, out: tuple[OutT1, OutT2, OutT3, OutT4], **kw: Unpack[_Kw14fc]
    ) -> tuple[OutT1, OutT2, OutT3, OutT4]: ...
    @overload
    def __call__[OutT1: _OutArray, OutT2: _OutArray, OutT3: _OutArray, OutT4: _OutArray](
        self, x: _ToComplex128_D, out1: OutT1, out2: OutT2, out3: OutT3, out4: OutT4, /, **kw: Unpack[_Kw14fc]
    ) -> tuple[OutT1, OutT2, OutT3, OutT4]: ...
...
class _UFunc21ld(_UFuncWithoutIdentity, _UFunc21[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    #
    @overload
    def __call__(self, n: onp.ToInt, x: onp.ToFloat64, /, out: _Out1[None] = None, **kw: Unpack[_Kw21ld]) -> np.float64: ...
    @overload
    def __call__(self, n: onp.ToIntND, x: _ToFloat64OrND, /, out: _Out1[None] = None, **kw: Unpack[_Kw21ld]) -> _Float64ND: ...
    @overload
    def __call__(self, n: _ToInt_D, x: onp.ToFloat64_ND, /, out: _Out1[None] = None, **kw: Unpack[_Kw21ld]) -> _Float64ND: ...
    @overload
    def __call__[OutT: _OutArray](self, n: _ToInt_D, x: _ToFloat64OrND, /, out: _Out1[OutT], **kw: Unpack[_Kw21ld]) -> OutT: ...
    #
    @override
    ...
    @overload
    def outer[OutT: _OutArray](self, n: _ToInt_D, x: _ToFloat64OrND, /, *, out: _Out1[OutT], **kw: Unpack[_Kw21ld]) -> OutT: ...
...
class _UFunc21f(_UFunc21[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__(self, a: onp.ToFloat64_ND, b: _ToFloat64OrND, /, out: _Out1[None] = None, **kw: Unpack[_Kw21f]) -> _FloatND: ...
    @overload
    def __call__(self, a: _ToFloat64OrND, b: onp.ToFloat64_ND, /, out: _Out1[None] = None, **kw: Unpack[_Kw21f]) -> _FloatND: ...
    @overload
    def __call__[OutT: _OutArray](
        self, a: _ToFloat64OrND, b: _ToFloat64OrND, /, out: _Out1[OutT], **kw: Unpack[_Kw21f]
    ) -> OutT: ...
    #
    @override
    ...
    @overload
    def outer(self, a: onp.ToFloat64_ND, b: _ToFloat64OrND, /, *, out: _Out1[None] = None, **kw: Unpack[_Kw21f]) -> _FloatND: ...
    @overload
    def outer(self, a: _ToFloat64OrND, b: onp.ToFloat64_ND, /, *, out: _Out1[None] = None, **kw: Unpack[_Kw21f]) -> _FloatND: ...
    @overload
    def outer[OutT: _OutArray](
        self, a: _ToFloat64OrND, b: _ToFloat64OrND, /, *, out: _Out1[OutT], **kw: Unpack[_Kw21f]
    ) -> OutT: ...

@final
@type_check_only
class _UFunc21ldf(_UFunc21[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    @property
    @override
    def ntypes(self, /) -> L[3]: ...
    @property
    ...
    @overload
    def __call__(self, a: onp.ToIntND, b: _ToFloat64OrND, /, out: _Out1[None] = None, **kw: Unpack[_Kw21ldf]) -> _Float64ND: ...
    @overload
    ...
    @overload
    def __call__(
        self, a: onp.ToFloat64_ND, b: _ToFloat64OrND, /, out: _Out1[None] = None, **kw: Unpack[_Kw21ldf]
    ) -> _FloatND: ...
    @overload
    def __call__(
        self, a: _ToFloat64OrND, b: onp.ToFloat64_ND, /, out: _Out1[None] = None, **kw: Unpack[_Kw21ldf]
    ) -> _FloatND: ...
    @overload
    def __call__[OutT: _OutArray](
        self, a: _ToFloat64OrND, b: _ToFloat64OrND, /, out: _Out1[OutT], **kw: Unpack[_Kw21ldf]
    ) -> OutT: ...
    #
    @override
    def at(self, a: _CoFloat64ND, indices: _Indices, b: _ToFloat64OrND, /) -> None: ...
...
class _UFunc21c1(_UFuncWithoutIdentity, _UFunc21[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__(
        self, a: onp.ToFloat64_ND, b: _ToComplex128_D, /, out: _Out1[None] = None, **kw: Unpack[_Kw21c1]
    ) -> _ComplexND: ...
    @overload
    def __call__(
        self, a: _ToFloat64OrND, b: _ToComplex128ND, /, out: _Out1[None] = None, **kw: Unpack[_Kw21c1]
    ) -> _ComplexND: ...
    @overload
    def __call__[OutT: _OutArray](
        self, a: _ToFloat64OrND, b: _ToComplex128_D, /, out: _Out1[OutT], **kw: Unpack[_Kw21c1]
    ) -> OutT: ...
    #
    @override
...
class _UFunc21fc1(_UFunc21[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__(
        self, a: _ToFloat64OrND, b: onp.ToFloat64_ND, /, out: _Out1[None] = None, **kw: Unpack[_Kw21fc1]
    ) -> _FloatND: ...
    @overload
    def __call__(
        self, a: onp.ToFloat64_ND, b: _ToFloat64OrND, /, out: _Out1[None] = None, **kw: Unpack[_Kw21fc1]
    ) -> _FloatND: ...
    @overload
    def __call__(
        self, a: onp.ToFloat64_ND, b: _ToComplex128_D, /, out: _Out1[None] = None, **kw: Unpack[_Kw21fc1]
    ) -> _InexactND: ...
    @overload
    def __call__(
        self, a: _ToFloat64OrND, b: _ToComplex128ND, /, out: _Out1[None] = None, **kw: Unpack[_Kw21fc1]
    ) -> _InexactND: ...
    @overload
    def __call__[OutT: _OutArray](
        self, a: _ToFloat64OrND, b: _ToComplex128_D, /, out: _Out1[OutT], **kw: Unpack[_Kw21fc1]
    ) -> OutT: ...
    #
...
@final
@type_check_only
class _UFunc21ldfc1(_UFunc21[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    # `eval_*`
    @property
    @override
    def ntypes(self, /) -> L[5]: ...
    ...
    @overload
    def __call__(self, a: onp.ToIntND, b: _ToFloat64OrND, /, out: _Out1[None] = None, **kw: Unpack[_Kw21fc1]) -> _Float64ND: ...
    @overload
...
class _UFunc21fc2(_UFunc21[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__(self, a: _ToSubComplex, b: _ToSubComplex, /, out: _Out1[None] = None, **kw: Unpack[_Kw21fc2]) -> _Inexact: ...
    @overload
    ...
    @overload
    def __call__(
        self, a: onp.ToFloat64_ND, b: _ToFloat64OrND, /, out: _Out1[None] = None, **kw: Unpack[_Kw21fc2]
    ) -> _FloatND: ...
    @overload
    def __call__(
        self, a: _ToComplex128ND, b: _ToComplex128_D, /, out: _Out1[None] = None, **kw: Unpack[_Kw21fc2]
    ) -> _InexactND: ...
    @overload
    def __call__(
        self, a: _ToComplex128_D, b: _ToComplex128ND, /, out: _Out1[None] = None, **kw: Unpack[_Kw21fc2]
    ) -> _InexactND: ...
    @overload
    def __call__[OutT: _OutArray](
        self, a: _ToComplex128_D, b: _ToComplex128_D, /, out: _Out1[OutT], **kw: Unpack[_Kw21fc2]
    ) -> OutT: ...
    #
    @override
    @overload
...
class _UFunc22f(_UFunc22[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__[OutT1: _OutArray, OutT2: _OutArray](
        self, v: _ToFloat64OrND, x: _ToFloat64OrND, /, out: tuple[OutT1, OutT2], **kw: Unpack[_Kw22f]
    ) -> tuple[OutT1, OutT2]: ...
    @overload
    def __call__[OutT1: _OutArray, OutT2: _OutArray](
        self, v: _ToFloat64OrND, x: _ToFloat64OrND, out1: OutT1, out2: OutT2, /, **kw: Unpack[_Kw22f]
    ) -> tuple[OutT1, OutT2]: ...
    #
    @override
    @overload
    ...
    @overload
    def outer[OutT1: _OutArray, OutT2: _OutArray](
        self, v: _ToFloat64OrND, x: _ToFloat64OrND, /, *, out: tuple[OutT1, OutT2], **kw: Unpack[_Kw22f]
    ) -> tuple[OutT1, OutT2]: ...
...
class _UFunc24f(_UFunc24[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__[OutT1: _OutArray, OutT2: _OutArray, OutT3: _OutArray, OutT4: _OutArray](
        self, u: _ToFloat64OrND, m: _ToFloat64OrND, /, out: tuple[OutT1, OutT2, OutT3, OutT4], **kw: Unpack[_Kw24f]
    ) -> tuple[OutT1, OutT2, OutT3, OutT4]: ...
    @overload
    def __call__[OutT1: _OutArray, OutT2: _OutArray, OutT3: _OutArray, OutT4: _OutArray](
        self, u: _ToFloat64OrND, m: _ToFloat64OrND, out1: OutT1, out2: OutT2, out3: OutT3, out4: OutT4, /, **kw: Unpack[_Kw24f]
    ) -> tuple[OutT1, OutT2, OutT3, OutT4]: ...
    #
    @override
    @overload
    ...
    @overload
    def outer[OutT1: _OutArray, OutT2: _OutArray, OutT3: _OutArray, OutT4: _OutArray](
        self, u: _ToFloat64OrND, m: _ToFloat64OrND, /, *, out: tuple[OutT1, OutT2, OutT3, OutT4], **kw: Unpack[_Kw24f]
    ) -> tuple[OutT1, OutT2, OutT3, OutT4]: ...
...
class _UFunc31f(_UFunc31[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__(
        self, a: _ToFloat64OrND, b: _ToFloat64OrND, x: onp.ToFloat64_ND, /, out: _Out1[None] = None, **kw: Unpack[_Kw31f]
    ) -> _FloatND: ...
    @overload
    def __call__(
        self, a: _ToFloat64OrND, b: onp.ToFloat64_ND, x: _ToFloat64OrND, /, out: _Out1[None] = None, **kw: Unpack[_Kw31f]
    ) -> _FloatND: ...
    @overload
    def __call__(
        self, a: onp.ToFloat64_ND, b: _ToFloat64OrND, x: _ToFloat64OrND, /, out: _Out1[None] = None, **kw: Unpack[_Kw31f]
    ) -> _FloatND: ...
    @overload
    def __call__[OutT: _OutArray](
        self, a: _ToFloat64OrND, b: _ToFloat64OrND, x: _ToFloat64OrND, /, out: _Out1[OutT], **kw: Unpack[_Kw31f]
    ) -> OutT: ...

@final
@type_check_only
class _UFunc31ldf(_UFunc31[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    # `nbdtr`, `nbdtrc`, and `nbdtri`
    @property
    @override
    def ntypes(self, /) -> L[3]: ...
    @property
    ...
    @overload
    def __call__(
        self, a: onp.ToIntND, b: _ToInt_D, x: _ToFloat64OrND, /, out: _Out1[None] = None, **kw: Unpack[_Kw31f]
    ) -> _Float64ND: ...
    @overload
    def __call__(
        self, a: _ToInt_D, b: onp.ToIntND, x: _ToFloat64OrND, /, out: _Out1[None] = None, **kw: Unpack[_Kw31f]
    ) -> _Float64ND: ...
    @overload
    def __call__(
        self, a: _ToInt_D, b: _ToInt_D, x: onp.ToFloat64_ND, /, out: _Out1[None] = None, **kw: Unpack[_Kw31f]
    ) -> _Float64ND: ...
    @overload
    def __call__(
        self, a: _ToSubFloat, b: _ToSubFloat, x: _ToSubFloat, /, out: _Out1[None] = None, **kw: Unpack[_Kw31f]
...
class _UFunc31fc1(_UFunc31[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__[ST: _Float_D](
        self, n: ST | _ToFloat32, a: ST, x: ST | _ToFloat32, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]
    ) -> ST: ...
    @overload
    def __call__[ST: _Float_D](
        self, n: ST, a: ST | _ToFloat32, x: ST | _ToFloat32, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]
    ) -> ST: ...
    @overload
    def __call__(
        self, n: _ToFloat64OrND, a: _ToFloat64OrND, x: onp.ToFloat64_ND, /, out: _Out1[None] = None, **kw: Unpack[_Kw31fc1]
    ) -> _FloatND: ...
    @overload
    def __call__(
        self, n: _ToFloat64OrND, a: onp.ToFloat64_ND, x: _ToFloat64OrND, /, out: _Out1[None] = None, **kw: Unpack[_Kw31fc1]
    ) -> _FloatND: ...
    @overload
    def __call__(
        self, n: onp.ToFloat64_ND, a: _ToFloat64OrND, x: _ToFloat64OrND, /, out: _Out1[None] = None, **kw: Unpack[_Kw31fc1]
    ) -> _FloatND: ...
    @overload
    def __call__(
        self, n: _ToFloat64OrND, a: _ToFloat64OrND, x: _ToComplex128ND, /, out: _Out1[None] = None, **kw: Unpack[_Kw31fc1]
    ) -> _InexactND: ...
    @overload
    def __call__(
        self, n: _ToFloat64OrND, a: onp.ToFloat64_ND, x: _ToComplex128_D, /, out: _Out1[None] = None, **kw: Unpack[_Kw31fc1]
    ) -> _InexactND: ...
    @overload
    def __call__(
        self, n: onp.ToFloat64_ND, a: _ToFloat64OrND, x: _ToComplex128_D, /, out: _Out1[None] = None, **kw: Unpack[_Kw31fc1]
    ) -> _InexactND: ...
    @overload
    def __call__[OutT: _OutArray](
        self, n: _ToFloat64OrND, a: _ToFloat64OrND, x: _ToComplex128_D, /, out: _Out1[OutT], **kw: Unpack[_Kw31fc1]
    ) -> OutT: ...

@final
@type_check_only
class _UFunc31ldfc1(_UFunc31[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    # `eval_{gegenbauer,genlaguerre}`
    @property
    @override
    def ntypes(self, /) -> L[5]: ...
    @property
    ...
    @overload
    def __call__(
        self, n: onp.ToIntND, a: _ToFloat64OrND, x: _ToFloat64OrND, /, out: _Out1[None] = None, **kw: Unpack[_Kw31fc1]
    ) -> _Float64ND: ...
    @overload
    def __call__(
        self, n: _ToInt_D, a: onp.ToFloat64_ND, x: _ToFloat64OrND, /, out: _Out1[None] = None, **kw: Unpack[_Kw31fc1]
    ) -> _Float64ND: ...
    @overload
    def __call__(
        self, n: _ToInt_D, a: _ToFloat64OrND, x: onp.ToFloat64_ND, /, out: _Out1[None] = None, **kw: Unpack[_Kw31fc1]
    ) -> _Float64ND: ...
    @overload
    def __call__(
        self, n: _ToSubFloat, a: _ToSubFloat, x: _ToSubFloat, /, out: _Out1[None] = None, **kw: Unpack[_Kw31fc1]
...
class _UFunc31fc3(_UFunc31[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__[ST: _Inexact_D](
        self, x: ST | _ToComplex64, y: ST, z: ST | _ToComplex64, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]
    ) -> ST: ...
    @overload
    def __call__[ST: _Inexact_D](
        self, x: ST, y: ST | _ToComplex64, z: ST | _ToComplex64, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]
    ) -> ST: ...
    @overload
    def __call__(
        self, x: _ToFloat64OrND, y: _ToFloat64OrND, z: onp.ToFloat64_ND, /, out: _Out1[None] = None, **kw: Unpack[_Kw31fc3]
    ) -> _FloatND: ...
    @overload
    def __call__(
        self, x: _ToFloat64OrND, y: onp.ToFloat64_ND, z: _ToFloat64OrND, /, out: _Out1[None] = None, **kw: Unpack[_Kw31fc3]
    ) -> _FloatND: ...
    @overload
    def __call__(
        self, x: onp.ToFloat64_ND, y: _ToFloat64OrND, z: _ToFloat64OrND, /, out: _Out1[None] = None, **kw: Unpack[_Kw31fc3]
    ) -> _FloatND: ...
    @overload
    def __call__(
        self, x: _ToComplex128_D, y: _ToComplex128_D, z: _ToComplex128ND, /, out: _Out1[None] = None, **kw: Unpack[_Kw31fc3]
    ) -> _InexactND: ...
    @overload
    def __call__(
        self, x: _ToComplex128_D, y: _ToComplex128ND, z: _ToComplex128_D, /, out: _Out1[None] = None, **kw: Unpack[_Kw31fc3]
    ) -> _InexactND: ...
    @overload
    def __call__(
        self, x: _ToComplex128ND, y: _ToComplex128_D, z: _ToComplex128_D, /, out: _Out1[None] = None, **kw: Unpack[_Kw31fc3]
    ) -> _InexactND: ...
    @overload
    def __call__[OutT: _OutArray](
        self, x: _ToComplex128_D, y: _ToComplex128_D, z: _ToComplex128_D, /, out: _Out1[OutT], **kw: Unpack[_Kw31fc3]
    ) -> OutT: ...
...
class _UFunc32f(_UFunc32[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__[ST: _Float_D](
        self, m: ST | _ToFloat32, q: ST, x: ST | _ToFloat32, /, out: _None2 = ..., **kw: Unpack[_KwBase]
    ) -> _Tuple2[ST]: ...
    @overload
    def __call__[ST: _Float_D](
        self, m: ST, q: ST | _ToFloat32, x: ST | _ToFloat32, /, out: _None2 = ..., **kw: Unpack[_KwBase]
    ) -> _Tuple2[ST]: ...
    @overload
    def __call__(
    ...
    @overload
    def __call__[OutT1: _OutArray, OutT2: _OutArray](
        self, m: _ToFloat64OrND, q: _ToFloat64OrND, x: _ToFloat64OrND, /, out: tuple[OutT1, OutT2], **kw: Unpack[_Kw32f]
    ) -> tuple[OutT1, OutT2]: ...
    @overload
    def __call__[OutT1: _OutArray, OutT2: _OutArray](
        self, m: _ToFloat64OrND, q: _ToFloat64OrND, x: _ToFloat64OrND, out1: OutT1, out2: OutT2, /, **kw: Unpack[_Kw32f]
    ) -> tuple[OutT1, OutT2]: ...
...
class _UFunc41fc1(_UFunc41[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__[ST: _Float_D](
        self, n: ST | _ToFloat32, a: ST | _ToFloat32, b: ST, x: ST | _ToFloat32, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]
    ) -> ST: ...
    @overload
    def __call__[ST: _Float_D](
        self, n: ST | _ToFloat32, a: ST, b: ST | _ToFloat32, x: ST | _ToFloat32, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]
    ) -> ST: ...
    @overload
    def __call__[ST: _Float_D](
        self, n: ST, a: ST | _ToFloat32, b: ST | _ToFloat32, x: ST | _ToFloat32, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]
    ) -> ST: ...
    @overload
    def __call__(
        self,
...
@final
@type_check_only
class _UFunc41ldfc1(_UFunc41[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    # `eval_[sh_]jacobi`
    @property
    @override
    def ntypes(self, /) -> L[5]: ...
...
# l->l
_sf_error_test_function: np.ufunc  # undocumented

# f->f; d->d
_cosine_cdf: _UFunc11f[L["_cosine_cdf"], L[0]] = ...  # undocumented
_cosine_invcdf: _UFunc11f[L["_cosine_invcdf"], L[0]] = ...  # undocumented
_factorial: _UFunc11f[L["_factorial"], L[0]] = ...  # undocumented
_kolmogc: _UFunc11f[L["_kolmogc"], L[0]] = ...  # undocumented
_kolmogci: _UFunc11f[L["_kolmogci"], L[0]] = ...  # undocumented
_kolmogp: _UFunc11f[L["_kolmogp"], L[0]] = ...  # undocumented
_lanczos_sum_expg_scaled: _UFunc11f[L["_lanczos_sum_expg_scaled"], L[0]] = ...  # undocumented
_lgam1p: _UFunc11f[L["_lgam1p"], L[0]] = ...  # undocumented
_log1pmx: _UFunc11f[L["_log1pmx"], L[0]] = ...  # undocumented
_scaled_exp1: _UFunc11f[L["_scaled_exp1"]] = ...  # undocumented
...
# f->f; d->d; F->F; D->D
_cospi: _UFunc11fc[L["_cospi"]] = ...  # undocumented
_sinpi: _UFunc11fc[L["_sinpi"]] = ...  # undocumented
_riemann_zeta: _UFunc11fc[L["_riemann_zeta"], L[0]] = ...  # undocumented
...
# ff->f; (l|d)d->d
_igam_fac: _UFunc21f[L["_igam_fac"], L[0]] = ...  # undocumented
_iv_ratio: _UFunc21f[L["_iv_ratio"], L[0]] = ...  # undocumented
_iv_ratio_c: _UFunc21f[L["_iv_ratio_c"], L[0]] = ...  # undocumented
_nbinom_mean: _UFunc21f[L["_nbinom_mean"], L[0]] = ...  # undocumented
_nbinom_variance: _UFunc21f[L["_nbinom_variance"], L[0]] = ...  # undocumented
_nbinom_skewness: _UFunc21f[L["_nbinom_skewness"], L[0]] = ...  # undocumented
_nbinom_kurtosis_excess: _UFunc21f[L["_nbinom_kurtosis_excess"], L[0]] = ...  # undocumented
_nct_mean: _UFunc21f[L["_nct_mean"], L[0]] = ...  # undocumented
_nct_variance: _UFunc21f[L["_nct_variance"], L[0]] = ...  # undocumented
_nct_skewness: _UFunc21f[L["_nct_skewness"], L[0]] = ...  # undocumented
_nct_kurtosis_excess: _UFunc21f[L["_nct_kurtosis_excess"], L[0]] = ...  # undocumented
_stirling2_inexact: _UFunc21f[L["_stirling2_inexact"]] = ...  # undocumented
...
_smirnovc: _UFunc21ldf[L["_smirnovc"], L[0]] = ...
_smirnovci: _UFunc21ldf[L["_smirnovci"], L[0]] = ...
_smirnovp: _UFunc21ldf[L["_smirnovp"], L[0]] = ...
smirnov: _UFunc21ldf[L["smirnov"], L[0]] = ...
smirnovi: _UFunc21ldf[L["smirnovi"], L[0]] = ...
tklmbda: _UFunc21f[L["tklmbda"], L[0]] = ...
kn: _UFunc21ldf[L["kn"], L[0]] = ...
yn: _UFunc21ldf[L["yn"], L[0]] = ...
...
eval_chebyc: _UFunc21ldfc1[L["eval_chebyc"], L[0]] = ...
eval_chebys: _UFunc21ldfc1[L["eval_chebys"], L[0]] = ...
eval_chebyt: _UFunc21ldfc1[L["eval_chebyt"], L[0]] = ...
eval_sh_chebyt: _UFunc21ldfc1[L["eval_sh_chebyt"], L[0]] = ...
eval_chebyu: _UFunc21ldfc1[L["eval_chebyu"], L[0]] = ...
eval_sh_chebyu: _UFunc21ldfc1[L["eval_sh_chebyu"], L[0]] = ...
eval_legendre: _UFunc21ldfc1[L["eval_legendre"], L[0]] = ...
eval_sh_legendre: _UFunc21ldfc1[L["eval_sh_legendre"], L[0]] = ...
eval_laguerre: _UFunc21ldfc1[L["eval_laguerre"], L[0]] = ...
...
# lf->f; ld->d; lF->F; lD->D
_spherical_in: np.ufunc = ...  # undocumented
_spherical_in_d: np.ufunc = ...  # undocumented
_spherical_jn: np.ufunc = ...  # undocumented
_spherical_jn_d: np.ufunc = ...  # undocumented
_spherical_kn: np.ufunc = ...  # undocumented
_spherical_kn_d: np.ufunc = ...  # undocumented
_spherical_yn: np.ufunc = ...  # undocumented
_spherical_yn_d: np.ufunc = ...  # undocumented
...
# ddl->dd
_struve_asymp_large_z: np.ufunc = ...  # undocumented
_struve_bessel_series: np.ufunc = ...  # undocumented
_struve_power_series: np.ufunc = ...  # undocumented

# fff->f; (ll|dl|dd)d->d
_beta_pdf: _UFunc31f[L["_beta_pdf"], L[0]] = ...  # undocumented
_beta_ppf: _UFunc31f[L["_beta_ppf"], L[0]] = ...  # undocumented
_binom_pmf: _UFunc31f[L["_binom_pmf"], L[0]] = ...  # undocumented
_binom_cdf: _UFunc31f[L["_binom_cdf"], L[0]] = ...  # undocumented
_binom_ppf: _UFunc31f[L["_binom_ppf"], L[0]] = ...  # undocumented
_binom_sf: _UFunc31f[L["_binom_sf"], L[0]] = ...  # undocumented
_binom_isf: _UFunc31f[L["_binom_isf"], L[0]] = ...  # undocumented
_cauchy_ppf: _UFunc31f[L["_cauchy_ppf"], L[0]] = ...  # undocumented
_cauchy_isf: _UFunc31f[L["_cauchy_isf"], L[0]] = ...  # undocumented
_hypergeom_mean: _UFunc31f[L["_hypergeom_mean"], L[0]] = ...  # undocumented
_hypergeom_variance: _UFunc31f[L["_hypergeom_variance"], L[0]] = ...  # undocumented
_hypergeom_skewness: _UFunc31f[L["_hypergeom_skewness"], L[0]] = ...  # undocumented
_invgauss_ppf: _UFunc31f[L["_invgauss_ppf"], L[0]] = ...  # undocumented
_invgauss_isf: _UFunc31f[L["_invgauss_isf"], L[0]] = ...  # undocumented
_landau_pdf: _UFunc31f[L["_landau_pdf"], L[0]] = ...  # undocumented
_landau_cdf: _UFunc31f[L["_landau_cdf"], L[0]] = ...  # undocumented
_landau_ppf: _UFunc31f[L["_landau_ppf"], L[0]] = ...  # undocumented
_landau_sf: _UFunc31f[L["_landau_sf"], L[0]] = ...  # undocumented
_landau_isf: _UFunc31f[L["_landau_isf"], L[0]] = ...  # undocumented
_nbinom_cdf: _UFunc31f[L["_nbinom_cdf"], L[0]] = ...  # undocumented
_nbinom_isf: _UFunc31f[L["_nbinom_isf"], L[0]] = ...  # undocumented
_nbinom_pmf: _UFunc31f[L["_nbinom_pmf"], L[0]] = ...  # undocumented
_nbinom_ppf: _UFunc31f[L["_nbinom_ppf"], L[0]] = ...  # undocumented
_nbinom_sf: _UFunc31f[L["_nbinom_sf"], L[0]] = ...  # undocumented
_ncf_mean: _UFunc31f[L["_ncf_mean"], L[0]] = ...  # undocumented
_ncf_variance: _UFunc31f[L["_ncf_variance"], L[0]] = ...  # undocumented
_ncf_skewness: _UFunc31f[L["_ncf_skewness"], L[0]] = ...  # undocumented
_ncf_kurtosis_excess: _UFunc31f[L["_ncf_kurtosis_excess"], L[0]] = ...  # undocumented
_nct_cdf: _UFunc31f[L["_nct_cdf"], L[0]] = ...  # undocumented
_nct_ppf: _UFunc31f[L["_nct_ppf"], L[0]] = ...  # undocumented
_nct_sf: _UFunc31f[L["_nct_sf"], L[0]] = ...  # undocumented
_nct_isf: _UFunc31f[L["_nct_isf"], L[0]] = ...  # undocumented
_ncx2_pdf: _UFunc31f[L["_ncx2_pdf"], L[0]] = ...  # undocumented
_ncx2_cdf: _UFunc31f[L["_ncx2_cdf"], L[0]] = ...  # undocumented
_ncx2_ppf: _UFunc31f[L["_ncx2_ppf"], L[0]] = ...  # undocumented
_ncx2_sf: _UFunc31f[L["_ncx2_sf"], L[0]] = ...  # undocumented
_ncx2_isf: _UFunc31f[L["_ncx2_isf"], L[0]] = ...  # undocumented
...
nbdtr: _UFunc31ldf[L["nbdtr"], L[0]] = ...
nbdtrc: _UFunc31ldf[L["nbdtrc"], L[0]] = ...
nbdtri: _UFunc31ldf[L["nbdtri"], L[0]] = ...
...
eval_gegenbauer: _UFunc31ldfc1[L["eval_gegenbauer"], L[0]] = ...
eval_genlaguerre: _UFunc31ldfc1[L["eval_genlaguerre"], L[0]] = ...
...
# ffff->f; dddd->d
_hypergeom_pmf: _UFunc41f[L["_hypergeom_pmf"], L[0]] = ...  # undocumented
_hypergeom_cdf: _UFunc41f[L["_hypergeom_cdf"], L[0]] = ...  # undocumented
_hypergeom_sf: _UFunc41f[L["_hypergeom_sf"], L[0]] = ...  # undocumented
_ncf_pdf: _UFunc41f[L["_ncf_pdf"], L[0]] = ...  # undocumented
_ncf_cdf: _UFunc41f[L["_ncf_cdf"], L[0]] = ...  # undocumented
_ncf_ppf: _UFunc41f[L["_ncf_ppf"], L[0]] = ...  # undocumented
_ncf_sf: _UFunc41f[L["_ncf_sf"], L[0]] = ...  # undocumented
_ncf_isf: _UFunc41f[L["_ncf_isf"], L[0]] = ...  # undocumented
_skewnorm_cdf: _UFunc41f[L["_skewnorm_cdf"], L[0]] = ...  # undocumented
_skewnorm_ppf: _UFunc41f[L["_skewnorm_ppf"], L[0]] = ...  # undocumented
_skewnorm_isf: _UFunc41f[L["_skewnorm_isf"], L[0]] = ...  # undocumented
...
eval_jacobi: _UFunc41ldfc1[L["eval_jacobi"], L[0]] = ...
eval_sh_jacobi: _UFunc41ldfc1[L["eval_sh_jacobi"], L[0]] = ...
...
_ellip_harm: np.ufunc = ...  # undocumented
