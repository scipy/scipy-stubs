...
type _Out1[MaybeOutT: onp.ArrayND[npc.number] | None] = tuple[MaybeOutT] | MaybeOutT
...
class _UFunc11f(_UFunc11[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    def __call__(self, x: _Float_DT, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]) -> _Float_DT: ...
...
class _UFunc11g(_UFunc11[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    def __call__(self, x: _LFloat_DT, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]) -> _LFloat_DT: ...
    @overload  # scalar, dtype= | signature=
...
class _UFunc11c(_UFunc11[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__(self, x: _Complex_DT, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]) -> _Complex_DT: ...
    @overload
...
class _UFunc11fc(_UFunc11[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__(self, x: _Inexact_DT, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]) -> _Inexact_DT: ...
    @overload
...
class _UFunc21f(_UFunc21[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__(
        self, a: _Float_DT, b: _Float_DT | _ToFloat32, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]
    ) -> _Float_DT: ...
    @overload
    def __call__(
        self, a: _Float_DT | _ToFloat32, b: _Float_DT, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]
    ) -> _Float_DT: ...
    @overload
...
class _UFunc21c1(_UFuncWithoutIdentity, _UFunc21[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__(self, a: _ToFloat32, b: _Complex_DT, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]) -> _Complex_DT: ...
    @overload
    def __call__(
...
class _UFunc21fc2(_UFunc21[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__(self, a: _ToFloat32, b: _Inexact_DT, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]) -> _Inexact_DT: ...
    @overload
    def __call__(self, a: _Inexact_DT, b: _ToFloat32, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]) -> _Inexact_DT: ...
    @overload
    def __call__(
...
class _UFunc31f(_UFunc31[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__(
        self, a: onp.ToFloat64, b: onp.ToFloat64, x: _Float_DT, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]
    ) -> _Float_DT: ...
    @overload
    def __call__(
        self, a: onp.ToFloat64, b: _Float_DT, x: onp.ToFloat64, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]
    ) -> _Float_DT: ...
    @overload
    def __call__(
        self, a: _Float_DT, b: onp.ToFloat64, x: onp.ToFloat64, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]
    ) -> _Float_DT: ...
    @overload
    def __call__(
...
class _UFunc31fc1(_UFunc31[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__(
        self, n: _ToFloat32, a: _ToFloat32, x: _Complex_DT, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]
    ) -> _Complex_DT: ...
    @overload
    def __call__(
        self,
...
class _UFunc41fc1(_UFunc41[_NameT_co, _IdentityT_co], Generic[_NameT_co, _IdentityT_co]):  # type: ignore[misc]
    ...
    @overload
    def __call__(
        self, n: _ToFloat32, a: _ToFloat32, b: _ToFloat32, x: _Complex_DT, /, out: _Out1[None] = None, **kw: Unpack[_KwBase]
    ) -> _Complex_DT: ...
    @overload
    def __call__(
        self,
