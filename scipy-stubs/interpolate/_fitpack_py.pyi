...
_TCK1D: TypeAlias = tuple[_Float1D, _Float1D, int | bool]
_TCK2D: TypeAlias = tuple[_Float1D, list[_Float1D], int | bool]
...
def splev(x: onp.ToFloatND, tck: BSpline, der: int | bool = 0, ext: _Ext = 0) -> _FloatND: ...
@overload  # tck: 1-d
def splev(x: onp.ToFloatND, tck: _ToTCK1D, der: int | bool = 0, ext: _Ext = 0) -> _FloatND: ...
@overload  # tck: 2-d
def splev(x: onp.ToFloatND, tck: _ToTCK2D, der: int | bool = 0, ext: _Ext = 0) -> list[_FloatND]: ...
@overload  # tck: ?-d
def splev(x: onp.ToFloatND, tck: _ToTCK, der: int | bool = 0, ext: _Ext = 0) -> _FloatND | list[_FloatND]: ...
...
#
@overload  # tck: BSpline
def sproot(tck: BSpline, mest: int | bool = 10) -> _Float1D | _Float2D: ...
@overload  # tck: 1-d
def sproot(tck: _ToTCK1D, mest: int | bool = 10) -> _Float1D: ...
@overload  # tck: 2-d
def sproot(tck: _ToTCK2D, mest: int | bool = 10) -> list[_Float1D]: ...
@overload  # tck: ?-d
...
#
@overload  # tck: BSpline
def insert(x: onp.ToFloat, tck: BSpline, m: int | bool = 1, per: onp.ToBool = 0) -> BSpline[np.float64]: ...
@overload  # tck: 1-d
def insert(x: onp.ToFloat, tck: _ToTCK1D, m: int | bool = 1, per: onp.ToBool = 0) -> _TCK1D: ...
@overload  # tck: 2-d
def insert(x: onp.ToFloat, tck: _ToTCK2D, m: int | bool = 1, per: onp.ToBool = 0) -> _TCK2D: ...
@overload  # tck: ?-d
def insert(x: onp.ToFloat, tck: _ToTCK, m: int | bool = 1, per: onp.ToBool = 0) -> _TCK1D | _TCK2D: ...

#
@overload  # tck: BSpline
def splder(tck: BSpline, n: int | bool = 1) -> BSpline[np.float64]: ...
@overload  # tck: 1-d
def splder(tck: _ToTCK1D, n: int | bool = 1) -> _TCK1D: ...
@overload  # tck: 2-d
def splder(tck: _ToTCK2D, n: int | bool = 1) -> _TCK2D: ...
@overload  # tck: ?-d
def splder(tck: _ToTCK, n: int | bool = 1) -> _TCK1D | _TCK2D: ...

#
@overload  # tck: BSpline
def splantider(tck: BSpline, n: int | bool = 1) -> BSpline[np.float64]: ...
@overload  # tck: 1-D
def splantider(tck: _ToTCK1D, n: int | bool = 1) -> _TCK1D: ...
@overload  # tck: 2-D
def splantider(tck: _ToTCK2D, n: int | bool = 1) -> _TCK2D: ...
@overload  # tck: ?-D
def splantider(tck: _ToTCK, n: int | bool = 1) -> _TCK1D | _TCK2D: ...
