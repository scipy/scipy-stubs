...
type _ValidateOutND[RealT: _Real, ShapeT: onp.AtLeast1D] = tuple[
    onp.ArrayND[RealT, ShapeT],
    np.dtype[RealT],
    onp.ArrayND[np.bool, ShapeT],
]  # fmt: skip
...
class UnivariateDistribution(_BaseDistribution[_XT_co, _ShapeT0_co], Generic[_XT_co, _ShapeT0_co]):
    ...
    #
    def __neg__(self, /) -> _LinDist[Self, np.float64, _ShapeT0_co]: ...
    def __abs__(self, /) -> _FoldDist[Self, np.float64, _ShapeT0_co]: ...

    #
    @overload
    def __add__(self, x: float | np.float64 | npc.integer | np.bool, /) -> _LinDist[Self, np.float64, _ShapeT0_co]: ...
    @overload
    def __add__(self, x: onp.ToFloat, /) -> _LinDist[Self, np.float64 | Any, _ShapeT0_co]: ...
    @overload
    def __add__[SelfT: _Dist[_0D], ShapeT: onp.AtLeast1D](
        self: SelfT, x: onp.ArrayND[np.float64, ShapeT], /
    ) -> _LinDist[SelfT, np.float64, ShapeT]: ...
    @overload
    def __add__[SelfT: _Dist[_0D], ShapeT: onp.AtLeast1D](
        self: SelfT, x: onp.ArrayND[npc.floating, ShapeT], /
    ) -> _LinDist[SelfT, np.float64 | Any, ShapeT]: ...
    @overload
    def __add__[SelfT: _Dist[onp.AtMost1D]](self: SelfT, x: onp.ToFloatStrict1D, /) -> _LinDist[SelfT, np.float64, _1D]: ...
    @overload
    def __add__[SelfT: _Dist[onp.AtMost2D]](self: SelfT, x: onp.ToFloatStrict2D, /) -> _LinDist[SelfT, np.float64, _2D]: ...
    @overload
    def __add__[SelfT: _Dist[onp.AtMost3D]](self: SelfT, x: onp.ToFloatStrict3D, /) -> _LinDist[SelfT, np.float64, _3D]: ...
    @overload
    ...
    #
    @overload
    def __sub__(self, lshift: float | np.float64 | npc.integer | np.bool, /) -> _LinDist[Self, np.float64, _ShapeT0_co]: ...
    @overload
    def __sub__(self, lshift: onp.ToFloat, /) -> _LinDist[Self, np.float64 | Any, _ShapeT0_co]: ...
    @overload
    def __sub__[SelfT: _Dist[_0D], ShapeT: onp.AtLeast1D](
        self: SelfT, lshift: onp.ArrayND[np.float64, ShapeT], /
    ) -> _LinDist[SelfT, np.float64, ShapeT]: ...
    @overload
    def __sub__[SelfT: _Dist[_0D], ShapeT: onp.AtLeast1D](
        self: SelfT, lshift: onp.ArrayND[npc.floating, ShapeT], /
    ) -> _LinDist[SelfT, np.float64 | Any, ShapeT]: ...
    @overload
    def __sub__[SelfT: _Dist[onp.AtMost1D]](self: SelfT, lshift: onp.ToFloatStrict1D, /) -> _LinDist[SelfT, np.float64, _1D]: ...
    @overload
    def __sub__[SelfT: _Dist[onp.AtMost2D]](self: SelfT, lshift: onp.ToFloatStrict2D, /) -> _LinDist[SelfT, np.float64, _2D]: ...
    @overload
    def __sub__[SelfT: _Dist[onp.AtMost3D]](self: SelfT, lshift: onp.ToFloatStrict3D, /) -> _LinDist[SelfT, np.float64, _3D]: ...
    @overload
    ...
    #
    @overload
    def __mul__(self, scale: float | np.float64 | npc.integer | np.bool, /) -> _LinDist[Self, np.float64, _ShapeT0_co]: ...
    @overload
    def __mul__(self, scale: onp.ToFloat, /) -> _LinDist[Self, np.float64 | Any, _ShapeT0_co]: ...
    @overload
    def __mul__[SelfT: _Dist[_0D], ShapeT: onp.AtLeast1D](
        self: SelfT, scale: onp.ArrayND[np.float64, ShapeT], /
    ) -> _LinDist[SelfT, np.float64, ShapeT]: ...
    @overload
    def __mul__[SelfT: _Dist[_0D], ShapeT: onp.AtLeast1D](
        self: SelfT, scale: onp.ArrayND[npc.floating, ShapeT], /
    ) -> _LinDist[SelfT, np.float64 | Any, ShapeT]: ...
    @overload
    def __mul__[SelfT: _Dist[onp.AtMost1D]](self: SelfT, scale: onp.ToFloatStrict1D, /) -> _LinDist[SelfT, np.float64, _1D]: ...
    @overload
    def __mul__[SelfT: _Dist[onp.AtMost2D]](self: SelfT, scale: onp.ToFloatStrict2D, /) -> _LinDist[SelfT, np.float64, _2D]: ...
    @overload
    def __mul__[SelfT: _Dist[onp.AtMost3D]](self: SelfT, scale: onp.ToFloatStrict3D, /) -> _LinDist[SelfT, np.float64, _3D]: ...
    @overload
    ...
    #
    @overload
    def __truediv__(self, iscale: float | np.float64 | npc.integer | np.bool, /) -> _LinDist[Self, np.float64, _ShapeT0_co]: ...
    @overload
    def __truediv__(self, iscale: onp.ToFloat, /) -> _LinDist[Self, np.float64 | Any, _ShapeT0_co]: ...
    @overload
    def __truediv__[SelfT: _Dist[_0D], ShapeT: onp.AtLeast1D](
        self: SelfT, iscale: onp.ArrayND[np.float64, ShapeT], /
    ) -> _LinDist[SelfT, np.float64, ShapeT]: ...
    @overload
    def __truediv__[SelfT: _Dist[_0D], ShapeT: onp.AtLeast1D](
        self: SelfT, iscale: onp.ArrayND[npc.floating, ShapeT], /
    ) -> _LinDist[SelfT, np.float64 | Any, ShapeT]: ...
    @overload
    def __truediv__[SelfT: _Dist[onp.AtMost1D]](
        self: SelfT, iscale: onp.ToFloatStrict1D, /
    ) -> _LinDist[SelfT, np.float64, _1D]: ...
    @overload
    def __truediv__[SelfT: _Dist[onp.AtMost2D]](
        self: SelfT, iscale: onp.ToFloatStrict2D, /
    ) -> _LinDist[SelfT, np.float64, _2D]: ...
    @overload
    def __truediv__[SelfT: _Dist[onp.AtMost3D]](
        self: SelfT, iscale: onp.ToFloatStrict3D, /
    ) -> _LinDist[SelfT, np.float64, _3D]: ...
    @overload
...
class Mixture(_BaseDistribution[_FloatT_co, _0D], Generic[_FloatT_co]):
    ...
    @property
    def components[FloatT: npc.floating](self: Mixture[FloatT], /) -> list[_CDist0[FloatT]]: ...
    @property
