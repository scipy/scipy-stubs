...
class _PyNCHypergeometric:
    ...
    def mode(self, /) -> int | bool: ...
    def mean(self, /) -> float | int | bool: ...
    def variance(self, /) -> float | int | bool: ...
    def probability(self, /, x: op.CanInt) -> float | int | bool: ...
    def moments(self, /) -> tuple[float | int | bool, float | int | bool]: ...
...
class _PyStochasticLib3:
    ...
    def Random(self, /) -> float | int | bool: ...
