...
@overload
def tukeylambda_variance(lam: onp.CanArrayND[npc.floating | npc.integer | np.bool_]) -> onp.Array[_ShapeT, np.float64]: ...
@overload
...
@overload
def tukeylambda_kurtosis(lam: onp.CanArrayND[npc.floating | npc.integer | np.bool_]) -> onp.Array[_ShapeT, np.float64]: ...
@overload
