...
class multivariate_normal_gen(multi_rv_generic):
    def __call__(
        self, /, mean: onp.ToFloat1D | None = None, cov: _AnyCov = 1, allow_singular: bool = False, seed: spt.ToRNG = None
...
class dirichlet_gen(multi_rv_generic):
    ...
    @overload
    def rvs(
        self, /, alpha: onp.ToFloat1D, size: op.CanIndex | tuple[op.CanIndex] = 1, random_state: spt.ToRNG = None
    ) -> onp.Array2D[np.float64]: ...
    @overload
    def rvs(
        self, /, alpha: onp.ToFloat1D, size: tuple[op.CanIndex, op.CanIndex], random_state: spt.ToRNG = None
    ) -> onp.Array3D[np.float64]: ...
    @overload
    def rvs(
        self,
...
class dirichlet_frozen(multi_rv_frozen[dirichlet_gen]):
    ...
    @overload
    def rvs(self, /, size: op.CanIndex | tuple[op.CanIndex] = 1, random_state: spt.ToRNG = None) -> onp.Array2D[np.float64]: ...
    @overload
    def rvs(self, /, size: tuple[op.CanIndex, op.CanIndex], random_state: spt.ToRNG = None) -> onp.Array3D[np.float64]: ...
    @overload
    def rvs(
        self, /, size: tuple[op.CanIndex, op.CanIndex, op.CanIndex, *tuple[op.CanIndex, ...]], random_state: spt.ToRNG = None
    ) -> onp.Array[onp.AtLeast3D, np.float64]: ...

class wishart_gen(multi_rv_generic):
    def __call__(
        self, /, df: onp.ToFloat | None = None, scale: _ToFloatMax2D | None = None, seed: spt.ToRNG = None
    ) -> wishart_frozen: ...
    ...
    def rvs(
        self, /, df: onp.ToFloat, scale: _ToFloatMax2D, size: onp.ToJustInt | tuple[int, ...] = 1, random_state: spt.ToRNG = None
    ) -> _ScalarOrArray_f8: ...
...
class multinomial_gen(multi_rv_generic):
    ...
    @overload
    def rvs(
        self, /, n: onp.ToJustIntND, p: _ToJustFloatND, size: tuple[()], random_state: spt.ToRNG = None
...
class multinomial_frozen(multi_rv_frozen[multinomial_gen]):
    ...
    @overload
    def rvs(self, /, size: onp.AtLeast1D | int = 1, random_state: spt.ToRNG = None) -> onp.Array[onp.AtLeast2D, np.float64]: ...

@type_check_only
class _group_rv_gen_mixin(Generic[_RVF_co]):
    def __call__(self, /, dim: onp.ToJustInt | None = None, seed: spt.ToRNG = None) -> _RVF_co: ...
    def rvs(
        self, /, dim: onp.ToJustInt, size: onp.ToJustInt | None = 1, random_state: spt.ToRNG = None
    ) -> onp.Array3D[np.float64]: ...
...
class uniform_direction_gen(multi_rv_generic):
    ...
    def rvs(
        self, /, dim: onp.ToJustInt, size: onp.ToJustInt | None = None, random_state: spt.ToRNG = None
    ) -> onp.Array3D[np.float64]: ...

class uniform_direction_frozen(multi_rv_frozen[uniform_direction_gen]):
    dim: onp.ToJustInt
    def __init__(self, /, dim: onp.ToJustInt | None = None, seed: spt.ToRNG = None) -> None: ...
    def rvs(self, /, size: onp.ToJustInt | None = None, random_state: spt.ToRNG = None) -> onp.Array3D[np.float64]: ...

class random_correlation_gen(multi_rv_generic):
    def __call__(
        self, /, eigs: onp.ToFloat1D, seed: spt.ToRNG = None, tol: _ToJustFloat = 1e-13, diag_tol: _ToJustFloat = 1e-07
    ) -> random_correlation_frozen: ...
    def rvs(
        self, /, eigs: onp.ToFloat1D, random_state: spt.ToRNG = None, tol: _ToJustFloat = 1e-13, diag_tol: _ToJustFloat = 1e-07
    ) -> onp.ArrayND[np.float64]: ...
...
class multivariate_hypergeom_gen(multi_rv_generic):
    def __call__(
        self, /, m: onp.ToJustIntND, n: onp.ToJustInt | onp.ToJustIntND, seed: spt.ToRNG = None
    ...
    @overload
    def rvs(
        self, /, m: onp.ToIntND, n: onp.ToJustInt | onp.ToJustIntND, size: tuple[()], random_state: spt.ToRNG = None
    ) -> onp.Array[onp.AtLeast1D, np.float64]: ...
    @overload
    def rvs(
        self,
...
class multivariate_hypergeom_frozen(multi_rv_frozen[multivariate_hypergeom_gen]):
    ...
    @overload
    def rvs(
        self, /, size: op.CanIndex | tuple[op.CanIndex, *tuple[op.CanIndex, ...]] = 1, random_state: spt.ToRNG = None
    ) -> onp.Array[onp.AtLeast2D, np.float64]: ...
...
class dirichlet_multinomial_gen(multi_rv_generic):
    def __call__(self, /, alpha: onp.ToFloatND, n: onp.ToJustIntND, seed: spt.ToRNG = None) -> dirichlet_multinomial_frozen: ...
...
class vonmises_fisher_gen(multi_rv_generic):
    def __call__(
        self, /, mu: onp.ToFloat1D | None = None, kappa: op.JustInt = 1, seed: spt.ToRNG = None
...
class normal_inverse_gamma_frozen(multi_rv_frozen[normal_inverse_gamma_gen]):
    ...
    def rvs(
        self, /, size: op.CanIndex | tuple[op.CanIndex, ...] | None = None, random_state: spt.ToRNG = None
    ) -> tuple[_ScalarOrArray_f8, _ScalarOrArray_f8]: ...
