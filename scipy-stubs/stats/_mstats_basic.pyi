...
#
def argstoarray(arg0: onp.ToFloat1D, /, *args: onp.ToFloat1D) -> onp.MArray2D[np.float64]: ...
...
#
@overload  # 0d ~int
def msign(x: op.JustInt) -> onp.Array0D[np.int_]: ...
@overload  # 0d ~float
def msign(x: op.JustFloat) -> onp.Array0D[np.float64]: ...
@overload  # 0d ~complex
def msign(x: op.JustComplex) -> onp.Array0D[np.complex128]: ...
@overload  # 1d ~int
def msign(x: list[int]) -> onp.Array1D[np.int_]: ...
@overload  # ?d ~int
def msign(x: onp.SequenceND[list[int]]) -> onp.ArrayND[np.int_]: ...
@overload  # 1d ~float
def msign(x: list[float]) -> onp.Array1D[np.float64]: ...
@overload  # ?d ~float
def msign(x: onp.SequenceND[list[float]]) -> onp.ArrayND[np.float64]: ...
@overload  # 1d ~complex
def msign(x: list[complex]) -> onp.Array1D[np.complex128]: ...
@overload  # ?d ~complex
def msign(x: onp.SequenceND[list[complex]]) -> onp.ArrayND[np.complex128]: ...
@overload  # ?d ~m8
def msign(x: onp.ArrayND[np.timedelta64]) -> onp.ArrayND[np.float64]: ...
@overload  # ?d T@+number
def msign[ShapeT: tuple[int, ...], ScalarT: npc.number | np.object_](
...
def pearsonr(x: onp.ToJustFloat32_ND, y: onp.ToFloat32_ND) -> PearsonRResult[np.float32, np.float32]: ...
@overload  # +float32, ~f32
def pearsonr(x: onp.ToFloat32_ND, y: onp.ToJustFloat32_ND) -> PearsonRResult[np.float32, np.float32]: ...
@overload  # ~f16, +float16
def pearsonr(x: onp.ToJustFloat16_ND, y: onp.ToFloat16_ND) -> PearsonRResult[np.float16, np.float32]: ...
@overload  # +float16, ~f16
def pearsonr(x: onp.ToFloat16_ND, y: onp.ToJustFloat16_ND) -> PearsonRResult[np.float16, np.float32]: ...
@overload  # +floating, +floating
def pearsonr(x: onp.ToFloatND, y: onp.ToFloatND) -> PearsonRResult[np.float64 | Any, np.float64 | Any]: ...
...
#
def obrientransform(arg0: onp.ToFloat1D, /, *args: onp.ToFloat1D) -> onp.MArray2D[np.float64]: ...

#
@overload  # ?d ~f64, axis=None
def sem(a: onp.ToComplex128_ND, *, axis: None, ddof: onp.ToInt = 1) -> np.float64: ...
@overload  # ?d ~f80, axis=None
def sem(a: onp.ToArrayND[npc.inexact80, npc.inexact80], *, axis: None, ddof: onp.ToInt = 1) -> np.longdouble: ...
@overload  # ?d ~f64, axis=<given>
def sem(a: _ToComplex128StrictND, axis: SupportsIndex = 0, ddof: onp.ToInt = 1) -> onp.MArray[np.float64] | Any: ...
@overload  # ?d ~f80, axis=<given>
def sem(
    a: onp.ArrayND[npc.inexact80, _JustAnyShape], axis: SupportsIndex = 0, ddof: onp.ToInt = 1
) -> onp.MArray[np.longdouble] | Any: ...
@overload  # 1d ~f64, axis=<given>
def sem(a: onp.ToComplex128Strict1D, axis: SupportsIndex = 0, ddof: onp.ToInt = 1) -> np.float64: ...
@overload  # 1d ~f80, axis=<given>
def sem(a: onp.ToArrayStrict1D[npc.inexact80, npc.inexact80], axis: SupportsIndex = 0, ddof: onp.ToInt = 1) -> np.longdouble: ...
@overload  # 2d ~f64, axis=<given>
def sem(a: onp.ToComplex128Strict2D, axis: SupportsIndex = 0, ddof: onp.ToInt = 1) -> onp.MArray1D[np.float64]: ...
@overload  # 2d ~f80, axis=<given>
def sem(
    a: onp.ToArrayStrict2D[npc.inexact80, npc.inexact80], axis: SupportsIndex = 0, ddof: onp.ToInt = 1
) -> onp.MArray1D[np.longdouble]: ...
@overload  # Nd ~f64
def sem(a: onp.ToComplex128_ND, axis: SupportsIndex | None = 0, ddof: onp.ToInt = 1) -> onp.MArray[np.float64] | Any: ...
@overload  # Nd fallback
def sem(a: onp.ToComplexND, axis: SupportsIndex | None = 0, ddof: onp.ToInt = 1) -> onp.MArray[np.float64 | Any] | Any: ...
