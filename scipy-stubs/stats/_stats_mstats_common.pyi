...
class SiegelslopesResult(BaseBunch[float | int | bool, float | int | bool]):
    def __new__(_cls, slope: float | int | bool, intercept: float | int | bool) -> Self: ...
    def __init__(self, /, slope: float | int | bool, intercept: float | int | bool) -> None: ...
    @property
    def slope(self, /) -> float | int | bool: ...
    @property
    def intercept(self, /) -> float | int | bool: ...
...
def theilslopes(
    y: onp.ToFloatND,
    x: onp.ToFloat1D | None = None,
    alpha: float | int | bool | np.floating[Any] = 0.95,
