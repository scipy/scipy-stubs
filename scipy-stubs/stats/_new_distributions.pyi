...
class Binomial(DiscreteDistribution[np.float64, _ShapeT_co], Generic[_ShapeT_co]):
    ...
    @property
    def n(self, /) -> np.float64 | onp.ArrayND[np.float64, _ShapeT_co]: ...
    @property
    def p(self, /) -> np.float64 | onp.ArrayND[np.float64, _ShapeT_co]: ...
