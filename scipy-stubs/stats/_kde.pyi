...
type _ToF64 = np.float64 | np.float32 | np.float16 | npc.integer | np.bool
...
class gaussian_kde(Generic[_ScalarT_co]):
    ...
    #
    @overload  # +f64
    def __call__(self: gaussian_kde[_ToF64], /, points: _ToFloatMax2D) -> onp.Array1D[np.float64]: ...
    @overload  # ~f80
    def __call__(self: gaussian_kde[npc.floating80], /, points: _ToFloatMax2D) -> onp.Array1D[np.longdouble]: ...
    @overload
    def __call__(self, /, points: _ToFloatMax2D) -> onp.Array1D[np.float64 | Any]: ...

    #
    @overload  # +f64
    def evaluate(self: gaussian_kde[_ToF64], /, points: _ToFloatMax2D) -> onp.Array1D[np.float64]: ...
    @overload  # ~f80
    def evaluate(self: gaussian_kde[npc.floating80], /, points: _ToFloatMax2D) -> onp.Array1D[np.longdouble]: ...
    @overload
    def evaluate(self, /, points: _ToFloatMax2D) -> onp.Array1D[np.float64 | Any]: ...

    #
    @overload  # +f64
    def pdf(self: gaussian_kde[_ToF64], /, x: _ToFloatMax2D) -> onp.Array1D[np.float64]: ...
    @overload  # ~f80
    def pdf(self: gaussian_kde[npc.floating80], /, x: _ToFloatMax2D) -> onp.Array1D[np.longdouble]: ...
    @overload
    def pdf(self, /, x: _ToFloatMax2D) -> onp.Array1D[np.float64 | Any]: ...

    #
    @overload  # +f64
    def logpdf(self: gaussian_kde[_ToF64], /, x: _ToFloatMax2D) -> onp.Array1D[np.float64]: ...
    @overload  # ~f80
    def logpdf(self: gaussian_kde[npc.floating80], /, x: _ToFloatMax2D) -> onp.Array1D[np.longdouble]: ...
    @overload
    def logpdf(self, /, x: _ToFloatMax2D) -> onp.Array1D[np.float64 | Any]: ...
    ...
    @overload  # ~floating80
    def resample(
        self: gaussian_kde[npc.floating80], /, size: int | None = None, seed: onp.random.ToRNG | None = None
