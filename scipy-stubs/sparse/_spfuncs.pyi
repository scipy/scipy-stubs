...
_SizeT = TypeVar("_SizeT", bound=int | bool)
_BlockSize: TypeAlias = tuple[_SizeT, _SizeT]

def estimate_blocksize(
    A: _spbase | onp.ToComplex2D,
    efficiency: float | int | bool | Floating = 0.7,
) -> _BlockSize[L[1]] | _BlockSize[L[2]] | _BlockSize[L[3]] | _BlockSize[L[4]] | _BlockSize[L[6]]: ...

#
def count_blocks(A: _spbase | onp.ToComplex2D, blocksize: tuple[onp.ToJustInt, onp.ToJustInt]) -> int | bool: ...
