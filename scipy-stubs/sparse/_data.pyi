...
class _data_matrix(_spbase[_SCT_co, _ShapeT_co], Generic[_SCT_co, _ShapeT_co]):
    ...
    @overload
    def __init__(
        self: _data_matrix[_SCT, tuple[int | bool]],
        /,
        arg1: Sequence[_SCT],
        *,
        maxprint: int | bool | None = None,
    ...
    @overload
    def __init__(
        self: _data_matrix[_SCT, tuple[int | bool, int | bool]],
        /,
    ...
    @overload
    def __init__(
        self: _data_matrix[np.float64, tuple[int | bool]],
        /,
        arg1: ToShape1D,
        *,
        maxprint: int | bool | None = None,
    ...
    @overload
    def __init__(
        self: _data_matrix[np.float64, tuple[int | bool, int | bool]],
        /,
        arg1: ToShape2D,
        *,
        maxprint: int | bool | None = None,
    ...
    @overload
    def __init__(self, /, arg1: onp.CanArrayND[_SCT_co], *, maxprint: int | bool | None = None) -> None: ...
...
class _minmax_mixin(Generic[_SCT_co, _ShapeT_co]):
    ...
    @overload  # 1-d, axis: int | bool, out: None = ...
    def max(
        self: _minmax_mixin[Any, tuple[int | bool]],
        /,
    ...
    @overload  # sparray, axis: int | bool, out: None = ...
    def max(
        self: sparray, /, axis: onp.ToInt, out: None = None, *, explicit: bool = False
    ) -> coo_array[_SCT_co, tuple[int | bool]]: ...  # type: ignore[misc]
    @overload  # spmatrix, axis: int | bool, out: None = ...
    ...
    def nanmax(  # type: ignore[misc]
        ...
        *,
        explicit: bool = False,
    ) -> coo_array[_SCT_co, tuple[int | bool]]: ...
    @overload  # spmatrix, axis: int | bool, out: None = ...
    ...
    @overload  # axis: None = ..., out: None = ...
    def argmax(self, /, axis: None = None, out: None = None, *, explicit: bool = False) -> int | bool: ...
    @overload  # 1-d, axis: int | bool, out: None = ...
    def argmax(
        self: _minmax_mixin[Any, tuple[int | bool]],
        /,
    ...
    #
    @overload  # axis: None = ..., out: None = ...
    def argmin(self, /, axis: None = None, out: None = None, *, explicit: bool = False) -> int | bool: ...
    @overload  # 1-d, axis: int | bool, out: None = ...
    def argmin(
        self: _minmax_mixin[Any, tuple[int | bool]],
        /,
