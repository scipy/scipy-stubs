...
class _spbase(SparseABC, Generic[_ScalarT_co, _ShapeT_co]):
    ...
    def __mul__(self: _SpArray, /, other: _spbase[np.bool_ | _ScalarT_co]) -> _SpArrayOut[_ScalarT_co]: ...
    ...
    @overload  # sparray[-Bool], /, other: sparse +Bool
    def __rmul__(self: _SpArray, /, other: _spbase[np.bool_ | _ScalarT_co]) -> _SpArrayOut[_ScalarT_co]: ...
    @overload  # sparray[-Bool], /, other: array-like +Bool
    ...
    #
    @overload  # sparray[-Bool], other: sparse +Bool
    def __matmul__(self: _SpArray, other: _spbase[np.bool_ | _ScalarT_co], /) -> _SpArrayOut[_ScalarT_co]: ...
    @overload  # sparray[-Bool], other: array-like +Bool
    ...
    @overload  # catch-all
    def astype(self, /, dtype: npt.DTypeLike, casting: Casting = "unsafe", copy: bool = True) -> _spbase[Any, _ShapeT_co]: ...
    ...
    #
    @overload
    def todok(self: _SpArrayND[_ShapeT], /, copy: bool = False) -> dok_array[_ScalarT_co, _ShapeT]: ...
    @overload
