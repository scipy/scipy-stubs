...
class _spbase(SparseABC, Generic[_ScalarT_co, _ShapeT_co]):
    ...
    @overload  # Self[-Bool], /, other: scalar-like +Bool
    def __rmul__(self, /, other: bool | _ToBool) -> Self: ...
    @overload  # Self[-Int], /, other: scalar-like +Int
    ...
    @overload  # sparray[-Bool], /, other: sparse +Bool
    def __rmul__(self: _SpArray, /, other: _spbase[_ToBool | _ScalarT_co]) -> _SpArrayOut[_ScalarT_co]: ...
    @overload  # sparray[-Bool], /, other: array-like +Bool
    def __rmul__(self: _SpArray, /, other: _To2DLike[bool, _ToBool]) -> coo_array[_ScalarT_co, _ShapeT_co]: ...
    @overload  # sparray[-Int], /, other: sparse +Int
    ...
    @overload  # spmatrix[-Bool], /, other: sparse +Bool
    def __rmul__(self: spmatrix, /, other: _spbase[_ToBool]) -> _SpMatrixOut[_ScalarT_co]: ...
    @overload  # spmatrix[-Bool], /, other: array-like +Bool
    def __rmul__(self: spmatrix, /, other: _To2D[bool, _ToBool]) -> onp.Array2D[_ScalarT_co]: ...
    @overload  # spmatrix[-Int], /, other: sparse +Int
    ...
    @overload  # spmatrix[+Bool], /, other: scalar- or matrix-like ~Int
    def __rmul__(self: spmatrix[_ToBool], /, other: _SparseLike[op.JustInt, Integer]) -> spmatrix[Integer]: ...
    @overload  # spmatrix[+Bool], /, other: array-like ~Int
    def __rmul__(self: spmatrix[_ToBool], /, other: _To2D[op.JustInt, Integer]) -> onp.Array2D[Integer]: ...
    @overload  # spmatrix[+Int], /, other: scalar- or matrix-like ~Float
    def __rmul__(self: spmatrix[_ToInt], /, other: _SparseLike[op.JustFloat, Floating]) -> spmatrix[Floating]: ...
    @overload  # spmatrix[+Int], /, other: array-like ~Float
    def __rmul__(self: spmatrix[_ToInt], /, other: _To2D[op.JustFloat, Floating]) -> onp.Array2D[Floating]: ...
    @overload  # spmatrix[+Float], /, other: scalar- or matrix-like ~Complex
    def __rmul__(self: spmatrix[_ToFloat], /, other: _SparseLike[op.JustComplex, CFloating]) -> spmatrix[CFloating]: ...
    @overload  # spmatrix[+Float], /, other: array-like ~Complex
    def __rmul__(self: spmatrix[_ToFloat], /, other: _To2D[op.JustComplex, CFloating]) -> onp.Array2D[CFloating]: ...
    @overload  # Self[+Bool], /, other: -Int
    def __rmul__(self: _spbase[_ToBool], /, other: _FromIntT) -> _spbase[_FromIntT, _ShapeT_co]: ...
    @overload  # Self[+Int], /, other: -Float
    ...
    @overload  # catch-all
    def __rmul__(self, /, other: _To2DLike[complex, Numeric] | _spbase) -> _spbase[Any] | onp.ArrayND[Any]: ...
