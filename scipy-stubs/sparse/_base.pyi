...
class _spbase(SparseABC, Generic[_ScalarT_co, _ShapeT_co]):
    ...
    def __mul__(self: spmatrix, /, other: _To2D[bool, np.bool]) -> onp.Array2D[_ScalarT_co]: ...
    ...
    def __mul__(self: _spbase[np.bool], /, other: _FromIntT) -> _spbase[_FromIntT, _ShapeT_co]: ...
    ...
    @overload  # spmatrix[-Bool], /, other: array-like +Bool
    def __rmul__(self: spmatrix, /, other: _To2D[bool, np.bool]) -> onp.Array2D[_ScalarT_co]: ...
    @overload  # spmatrix[-Int], /, other: sparse +Int
    ...
    @overload  # Self[+Bool], /, other: -Int
    def __rmul__(self: _spbase[np.bool], /, other: _FromIntT) -> _spbase[_FromIntT, _ShapeT_co]: ...
    @overload  # Self[+Int], /, other: -Float
    ...
    @overload  # spmatrix[-Bool], other: array-like +Bool
    def __matmul__(self: spmatrix, other: _To2D[bool, np.bool], /) -> onp.Array2D[_ScalarT_co]: ...
    @overload  # spmatrix[-Int], other: sparse +Int
    ...
    @overload  # spmatrix[-Bool], /, other: array-like +Bool
    def dot(self: spmatrix, /, other: _To2D[bool, np.bool]) -> onp.Array2D[_ScalarT_co]: ...
    @overload  # spmatrix[-Int], /, other: sparse +Int
    ...
    def sum(self, /, axis: SupportsIndex | None = None, dtype: npt.DTypeLike | None = None, *, out: _ArrayT) -> _ArrayT: ...
    ...
    #
    @overload  # out: array (keyword)
    def mean(self, /, axis: SupportsIndex | None = None, dtype: npt.DTypeLike | None = None, *, out: _ArrayT) -> _ArrayT: ...
    @overload  # axis: None = ..., dtype: <known>  (keyword)
