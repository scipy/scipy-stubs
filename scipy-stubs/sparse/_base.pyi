...
_SpArrayOutT = TypeVar("_SpArrayOutT", bound=_SpArrayOut[Any])
...
class _spbase(SparseABC, Generic[_ScalarT_co, _ShapeT_co]):  # pyrefly: ignore[implicit-abstract-class]
    ...
    @overload  # Self[+Bool]
    def sum(self: _spbase[np.bool], /, axis: None = None, dtype: None = None, out: None = None) -> np.int_: ...
    @overload  # sparray[-Bool, 2d], axis: index
    def sum(self: _SpArray2D[np.bool], /, axis: SupportsIndex, dtype: None = None, out: None = None) -> onp.Array1D[np.int_]: ...
    @overload  # sparray[-Bool, 2d], axis: index
    def sum(self: _SpArray1D[np.bool], /, axis: SupportsIndex | None = None, dtype: None = None, out: None = None) -> np.int_: ...
    @overload  # spmatrix[-Bool], axis: index
    def sum(self: spmatrix[np.bool], /, axis: SupportsIndex, dtype: None = None, out: None = None) -> onp.Matrix[np.int_]: ...
    @overload  # Self[-Int]
    def sum(self: _spbase[_FromIntT], /, axis: None = None, dtype: None = None, out: None = None) -> _FromIntT: ...
    @overload  # sparray[-Int, 2d], axis: index
    def sum(
        self: _SpArray2D[_FromIntT], /, axis: SupportsIndex, dtype: None = None, out: None = None
    ) -> onp.Array1D[_FromIntT]: ...
    @overload  # sparray[-Int, 1d], axis: index
    def sum(
        self: _SpArray1D[_FromIntT], /, axis: SupportsIndex | None = None, dtype: None = None, out: None = None
    ) -> _FromIntT: ...
    @overload  # spmatrix[-Int], axis: index
    def sum(self: spmatrix[_FromIntT], /, axis: SupportsIndex, dtype: None = None, out: None = None) -> onp.Matrix[_FromIntT]: ...
