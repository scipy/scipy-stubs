...
class _spbase(SparseABC, Generic[_ScalarT_co, _ShapeT_co]):
    ...
    @overload  # Self[+Int], axis: None = ...
    def mean(self: _spbase[np.bool], /, axis: None = None, dtype: None = None, out: None = None) -> np.float64: ...
    @overload  # sparray[-Float, 2d], axis: index
    def mean(
        self: _SpArray2D[_FromFloatT], /, axis: SupportsIndex, dtype: None = None, out: None = None
    ) -> onp.Array1D[_FromFloatT]: ...
    @overload  # sparray[+Int, 2d], axis: index
    def mean(
        self: _SpArray2D[np.bool], /, axis: SupportsIndex, dtype: None = None, out: None = None
    ...
    def mean(
        self: _SpArray1D[np.bool], /, axis: SupportsIndex | None = None, dtype: None = None, out: None = None
    ) -> np.float64: ...
    @overload  # spmatrix[-Float], axis: index
    def mean(
    ...
    @overload  # spmatrix[+Int], axis: index
    def mean(self: spmatrix[np.bool], /, axis: SupportsIndex, dtype: None = None, out: None = None) -> onp.Matrix[np.float64]: ...
    @overload  # spmatrix, axis: index, dtype: <unknown>
