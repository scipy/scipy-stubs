...
_ScalarT_co = TypeVar("_ScalarT_co", bound=Numeric, default=Numeric, covariant=True)
...
class _spbase(SparseABC, Generic[_ScalarT_co, _ShapeT_co]):
    ...
    def __add__(self, other: Falsy | _spbase[_ScalarT_co], /) -> Self: ...
    ...
    #
    @overload  # `0` or sparse of same dtype
    def __sub__(self, other: _spbase[_ScalarT_co], /) -> Self: ...
    @overload  # sparse[-Int], sparse[+Int8]
    ...
    def __mul__(self: _SpArray, /, other: _spbase[_ToBool | _ScalarT_co]) -> _SpArrayOut[_ScalarT_co]: ...
    @overload  # sparray[-Bool], /, other: array-like +Bool
    def __mul__(self: _SpArray, /, other: _To2DLike[bool, _ToBool]) -> coo_array[_ScalarT_co, _ShapeT_co]: ...
    ...
    def __mul__(self: spmatrix, /, other: _spbase[_ToBool]) -> _SpMatrixOut[_ScalarT_co]: ...
    @overload  # spmatrix[-Bool], /, other: array-like +Bool
    def __mul__(self: spmatrix, /, other: _To2D[bool, _ToBool]) -> onp.Array2D[_ScalarT_co]: ...
    ...
    #
    @overload  # sparray[-Bool], other: sparse +Bool
    def __matmul__(self: _SpArray, other: _spbase[_ToBool | _ScalarT_co], /) -> _SpArrayOut[_ScalarT_co]: ...
    @overload  # sparray[-Bool], other: array-like +Bool
    def __matmul__(self: _SpArray, other: _To2DLike[bool, _ToBool], /) -> onp.ArrayND[_ScalarT_co, _ShapeT_co]: ...
    @overload  # sparray[-Int], other: sparse +Int
    ...
    @overload  # spmatrix[-Bool], other: sparse +Bool
    def __matmul__(self: spmatrix, other: _spbase[_ToBool], /) -> _SpMatrixOut[_ScalarT_co]: ...
    @overload  # spmatrix[-Bool], other: array-like +Bool
    def __matmul__(self: spmatrix, other: _To2D[bool, _ToBool], /) -> onp.Array2D[_ScalarT_co]: ...
    @overload  # spmatrix[-Int], other: sparse +Int
    ...
    @overload  # sparray[-Bool], /, other: sparse +Bool
    def dot(self: _SpArray, /, other: _spbase[_ToBool | _ScalarT_co]) -> _SpArrayOut[_ScalarT_co]: ...
    @overload  # sparray[-Bool], /, other: array-like +Bool
    def dot(self: _SpArray, /, other: _To2DLike[bool, _ToBool]) -> onp.ArrayND[_ScalarT_co, _ShapeT_co]: ...
    @overload  # sparray[-Int], /, other: sparse +Int
    ...
    @overload  # spmatrix[-Bool], /, other: sparse +Bool
    def dot(self: spmatrix, /, other: _spbase[_ToBool]) -> _SpMatrixOut[_ScalarT_co]: ...
    @overload  # spmatrix[-Bool], /, other: array-like +Bool
    def dot(self: spmatrix, /, other: _To2D[bool, _ToBool]) -> onp.Array2D[_ScalarT_co]: ...
    @overload  # spmatrix[-Int], /, other: sparse +Int
    ...
    @overload
    def asformat(self: _SpArray1D, /, format: L["csr"], copy: bool = False) -> csr_array[_ScalarT_co, _1D]: ...
    @overload
    def asformat(self: _SpArray2D, /, format: L["csr"], copy: bool = False) -> csr_array[_ScalarT_co, _2D]: ...
    @overload
    def asformat(self: sparray, /, format: L["csr"], copy: bool = False) -> csr_array[_ScalarT_co]: ...
    @overload
    ...
    @overload
    def asformat(self: _SpArray1D, /, format: L["dok"], copy: bool = False) -> dok_array[_ScalarT_co, _1D]: ...
    @overload
    def asformat(self: _SpArray2D, /, format: L["dok"], copy: bool = False) -> dok_array[_ScalarT_co, _2D]: ...
    @overload
    def asformat(self: sparray, /, format: L["dok"], copy: bool = False) -> dok_array[_ScalarT_co]: ...
    @overload
    ...
    def todense(self: spmatrix, /, order: OrderCF | None = None, out: None = None) -> onp.Matrix[_ScalarT_co]: ...
    @overload  # self: spmatrix, out: array (positional)
    def todense(self: spmatrix, /, order: OrderCF | None, out: onp.ArrayND[_ScalarT]) -> onp.Matrix[_ScalarT]: ...
    @overload  # self: spmatrix, out: array (keyword)
    def todense(self: spmatrix, /, order: OrderCF | None = None, *, out: onp.ArrayND[_ScalarT]) -> onp.Matrix[_ScalarT]: ...
    @overload  # out: None
    def todense(self, /, order: OrderCF | None = None, out: None = None) -> onp.Array[_ShapeT_co, _ScalarT_co]: ...
    ...
    #
    @overload  # out: None
    def toarray(self, /, order: OrderCF | None = None, out: None = None) -> onp.Array2D[_ScalarT_co]: ...
    @overload  # out: array (positional)
    ...
    #
    @overload
    def tocsr(self: _SpArray1D, /, copy: bool = False) -> csr_array[_ScalarT_co, _1D]: ...
    @overload
    def tocsr(self: _SpArray2D, /, copy: bool = False) -> csr_array[_ScalarT_co, _2D]: ...
    @overload
    def tocsr(self: sparray, /, copy: bool = False) -> csr_array[_ScalarT_co]: ...
    @overload
    ...
    #
    @overload
    def todok(self: _SpArray1D, /, copy: bool = False) -> dok_array[_ScalarT_co, _1D]: ...
    @overload
    def todok(self: _SpArray2D, /, copy: bool = False) -> dok_array[_ScalarT_co, _2D]: ...
    @overload
    def todok(self: sparray, /, copy: bool = False) -> dok_array[_ScalarT_co]: ...
    @overload
