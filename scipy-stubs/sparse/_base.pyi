...
class _spbase(SparseABC, Generic[_ScalarT_co, _ShapeT_co]):  # pyrefly: ignore[implicit-abstract-class]
    ...
    @overload
    def power(self, /, n: SupportsIndex, dtype: onp.AnyBoolDType) -> _spbase[np.bool_]: ...
    @overload
    ...
    def sum(self: _SpArray2D[np.bool_], /, axis: SupportsIndex, dtype: None = None, out: None = None) -> onp.Array1D[np.int_]: ...
    @overload  # sparray[-Bool, 2d], axis: index
    def sum(
        self: _SpArray1D[np.bool_], /, axis: SupportsIndex | None = None, dtype: None = None, out: None = None
    ) -> np.int_: ...
    @overload  # spmatrix[-Bool], axis: index
    def sum(self: spmatrix[np.bool_], /, axis: SupportsIndex, dtype: None = None, out: None = None) -> onp.Matrix[np.int_]: ...
    @overload  # Self[-Int]
    ...
    @overload  # sparray[+Int, 2d], axis: index
    def mean(
        self: _SpArray2D[np.bool_], /, axis: SupportsIndex, dtype: None = None, out: None = None
    ...
    @overload  # spmatrix[+Int], axis: index
    def mean(
        self: spmatrix[np.bool_], /, axis: SupportsIndex, dtype: None = None, out: None = None
