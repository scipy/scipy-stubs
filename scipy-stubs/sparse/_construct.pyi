...
_ToBlocksUnkown: TypeAlias = _ToBlocksSpArray | onp.ArrayND[np.object_]
...
def hstack(blocks: Seq[sparray], format: _FmtBSR, dtype: onp.ToDType[_SCT0]) -> bsr_array[_SCT0]: ...
...
def hstack(blocks: Seq[sparray], format: _FmtCSC, dtype: onp.ToDType[_SCT0]) -> csc_array[_SCT0]: ...
...
def hstack(blocks: Seq[sparray], format: _FmtDIA, dtype: onp.ToDType[_SCT0]) -> dia_array[_SCT0]: ...
...
def hstack(blocks: Seq[sparray], format: _FmtLIL, dtype: onp.ToDType[_SCT0]) -> lil_array[_SCT0]: ...
...
@overload  # sparray, format: "bsr", dtype: <known>
def vstack(blocks: Seq[sparray], format: _FmtBSR, dtype: onp.ToDType[_SCT0]) -> bsr_array[_SCT0]: ...
@overload  # sparray, format: "coo", dtype: <known>
def vstack(blocks: Seq[sparray], format: _FmtCOO, dtype: onp.ToDType[_SCT0]) -> _COOArray2D[_SCT0]: ...
@overload  # sparray, format: "csc", dtype: <known>
def vstack(blocks: Seq[sparray], format: _FmtCSC, dtype: onp.ToDType[_SCT0]) -> csc_array[_SCT0]: ...
@overload  # sparray, format: "csr", dtype: <known>
def vstack(blocks: Seq[sparray], format: _FmtCSR, dtype: onp.ToDType[_SCT0]) -> _CSRArray2D[_SCT0]: ...
@overload  # sparray, format: "dia", dtype: <known>
def vstack(blocks: Seq[sparray], format: _FmtDIA, dtype: onp.ToDType[_SCT0]) -> dia_array[_SCT0]: ...
@overload  # sparray, format: "dok", dtype: <known>
def vstack(blocks: Seq[sparray], format: _FmtDOK, dtype: onp.ToDType[_SCT0]) -> _DOKArray2D[_SCT0]: ...
@overload  # sparray, format: "lil", dtype: <known>
def vstack(blocks: Seq[sparray], format: _FmtLIL, dtype: onp.ToDType[_SCT0]) -> lil_array[_SCT0]: ...
...
def block_array(blocks: _ToBlocksUnkown, *, format: _FmtBSR, dtype: onp.ToDType[_SCT0]) -> bsr_array[_SCT0]: ...
...
def block_array(blocks: _ToBlocksUnkown, *, format: _FmtCSC, dtype: onp.ToDType[_SCT0]) -> csc_array[_SCT0]: ...
...
def block_array(blocks: _ToBlocksUnkown, *, format: _FmtDIA, dtype: onp.ToDType[_SCT0]) -> dia_array[_SCT0]: ...
...
def block_array(blocks: _ToBlocksUnkown, *, format: _FmtLIL, dtype: onp.ToDType[_SCT0]) -> lil_array[_SCT0]: ...
...
def bmat(blocks: _ToBlocks[spmatrix[_SCT0]], format: _Format, dtype: None = None) -> spmatrix[_SCT0]: ...
...
def bmat(blocks: _ToBlocks[spmatrix[_SCT0]], format: _Format, dtype: onp.ToDType[_SCT0]) -> spmatrix[_SCT0]: ...
