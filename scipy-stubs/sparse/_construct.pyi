...
def kron(A: _ToSpMatrix[_SCT1], B: _ToSpMatrix[_SCT2], format: _FmtNonBSR) -> _SpMatrix[_SCT1 | _SCT2]: ...
@overload  # A: sparray, B: sparse, format: {"bsr", None} = ...
def kron(A: sparray[_SCT1], B: _spbase[_SCT2], format: _FmtBSR | None = None) -> _BSRArray[_SCT1 | _SCT2]: ...
@overload  # A: sparray, B: sparse, format: <otherwise>
def kron(A: sparray[_SCT1], B: _spbase[_SCT2], format: _FmtNonBSR) -> _SpArray2D[_SCT1 | _SCT2]: ...
@overload  # A: sparse, B: sparray, format: {"bsr", None} = ...
def kron(A: _spbase[_SCT1], B: sparray[_SCT2], format: _FmtBSR | None = None) -> _BSRArray[_SCT1 | _SCT2]: ...
@overload  # A: sparse, B: sparray, format: <otherwise>
def kron(A: _spbase[_SCT1], B: sparray[_SCT2], format: _FmtNonBSR) -> _SpArray2D[_SCT1 | _SCT2]: ...
...
@overload  # A: spmatrix or 2d array-like, B: spmatrix or 2d array-like, format: <otherwise>
def kronsum(A: _ToSpMatrix[_SCT1], B: _ToSpMatrix[_SCT2], format: _FmtNonCSR) -> _SpMatrix[_SCT1 | _SCT2]: ...
@overload  # A: sparray, B: sparse, format: {"csr", None} = ...
def kronsum(A: sparray[_SCT1], B: _spbase[_SCT2], format: _FmtCSR | None = None) -> _CSRArray[_SCT1 | _SCT2]: ...
@overload  # A: sparray, B: sparse, format: <otherwise>
def kronsum(A: sparray[_SCT1], B: _spbase[_SCT2], format: _FmtNonCSR) -> _SpArray2D[_SCT1 | _SCT2]: ...
@overload  # A: sparse, B: sparray, format: {"csr", None} = ...
def kronsum(A: _spbase[_SCT1], B: sparray[_SCT2], format: _FmtCSR | None = None) -> _CSRArray[_SCT1 | _SCT2]: ...
@overload  # A: sparse, B: sparray, format: <otherwise>
def kronsum(A: _spbase[_SCT1], B: sparray[_SCT2], format: _FmtNonCSR) -> _SpArray2D[_SCT1 | _SCT2]: ...
@overload  # A: unknown array-like, B: unknown array-like  (catch-all)
def kronsum(
    A: onp.ToComplex2D | _spbase[_SCT], B: onp.ToComplex2D | _spbase[_SCT], format: SPFormat | None = None
) -> _SpBase2D[_SCT]: ...
...
def block_array(blocks: Seq[Seq[_spbase[_SCT]]], *, format: _FmtNonCOO, dtype: None = None) -> _SpArray2D[_SCT]: ...
