...
def expand_dims(  # type: ignore[overload-overlap]
    A: sparray[_SCT0, tuple[Never] | tuple[Never, Never]], /, *, axis: int = 0
) -> coo_array[_SCT0, tuple[int, int, *tuple[Any, ...]]]: ...
@overload
def expand_dims(A: sparray[_SCT0, tuple[int]], /, *, axis: int = 0) -> coo_array[_SCT0, tuple[int, int]]: ...
@overload
def expand_dims(A: sparray[_SCT0, tuple[int, int]], /, *, axis: int = 0) -> coo_array[_SCT0, tuple[int, int, int]]: ...
@overload
def expand_dims(A: sparray[_SCT0, tuple[int, int, int]], /, *, axis: int = 0) -> coo_array[_SCT0, tuple[int, int, int, int]]: ...
@overload  # TODO(@jorenham): shape-typing for coo_matrix
def expand_dims(A: spmatrix[_SCT0], /, *, axis: int = 0) -> coo_matrix[_SCT0]: ...
