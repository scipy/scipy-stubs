...
_ShapeT = TypeVar("_ShapeT", bound=tuple[int | bool, ...], default=Any)
...
_ScalarLike: TypeAlias = complex | float | int | bool | bytes | str | np.generic | onp.Array0D
...
def isshape(x: _SizedIndexIterable, nonneg: bool = False, *, allow_nd: tuple[int | bool, ...] = (2,)) -> bool: ...
...
def check_shape(
    ...
    current_shape: tuple[int | bool, ...] | None = None,
    *,
    allow_nd: tuple[int | bool, ...] = (2,),
) -> tuple[int | bool, ...]: ...
...
def safely_cast_index_arrays(
    A: coo_array[Any, tuple[int | bool, int | bool]] | coo_matrix,
    idx_dtype: onp.ToDType[np.int32] = ...,  # = np.int32
    msg: str = "",
) -> tuple[onp.Array1D[np.int32], onp.Array1D[np.int32]]: ...
...
@overload
def broadcast_shapes(shape0: tuple[int | bool], /, *shapes: onp.AtMost1D) -> tuple[int | bool]: ...
@overload
def broadcast_shapes(shape0: tuple[int | bool, int | bool], /, *shapes: onp.AtMost2D) -> tuple[int | bool, int | bool]: ...
@overload
def broadcast_shapes(
    shape0: tuple[int | bool, int | bool, int | bool], /, *shapes: onp.AtMost3D
