...
@overload  # catch-all
def tril(A: _spbase[_SCT] | onp.ToComplexND, k: int = 0, *, format: SPFormat | None = None) -> _spbase[_SCT]: ...
...
@overload  # catch-all
def triu(A: _spbase[_SCT] | onp.ToComplexND, k: int = 0, *, format: SPFormat | None = None) -> _spbase[_SCT]: ...
