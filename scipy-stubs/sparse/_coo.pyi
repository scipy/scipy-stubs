...
_Axes: TypeAlias = int | bool | tuple[Sequence[int | bool], Sequence[int | bool]]
...
class _coo_base(_data_matrix[_SCT, _ShapeT_co], _minmax_mixin[_SCT, _ShapeT_co], Generic[_SCT, _ShapeT_co]):
    ...
    def __init__(  # type: ignore[misc]
        self: coo_array[np.float64, tuple[int | bool]],
        /,
        arg1: ToShape1D,
    ...
    def __init__(
        self: _coo_base[np.float64, tuple[int | bool, int | bool]],
        /,
        arg1: ToShape2D,
    ...
    def __init__(
        self: _coo_base[np.bool_, tuple[int | bool]],
        /,
        arg1: Sequence[bool],
        shape: ToShape1D | None = None,
    ...
    def __init__(
        self: _coo_base[np.bool_, tuple[int | bool, int | bool]],
        /,
    ...
    @overload  # vector-like builtins.int | bool, dtype: type[int | bool] | None
    def __init__(
        self: _coo_base[np.int_, tuple[int | bool]],
        /,
    ...
    def __init__(
        self: _coo_base[np.int_, tuple[int | bool, int | bool]],
        /,
    ...
    @overload  # vectir-like builtins.float | int | bool, dtype: type[float | int | bool] | None
    def __init__(
        self: _coo_base[np.float64, tuple[int | bool]],
        /,
    ...
    def __init__(
        self: _coo_base[np.complex128, tuple[int | bool]],
        /,
    ...
    @overload  # matrix-like builtins.complex | float | int | bool, dtype: type[complex | float | int | bool] | None
    def __init__(
        self: _coo_base[np.complex128, tuple[int | bool, int | bool]],
        /,
    ...
    def __init__(
        self: _coo_base[_SCT0, tuple[int | bool]],
        /,
    ...
    def __init__(
        self: _coo_base[_SCT0, tuple[int | bool, int | bool]],
        /,
    ...
    # NOTE: due to a bug in `axes`, only `int | bool` can be used at the moment (passing a 2-tuple or 2-list raises `TypeError`)
    @overload
    ...
    @overload
    def tensordot(self: _spbase[_SubInt], /, other: _JustND[int | bool], axes: _Axes = 2) -> _ScalarOrDense[np.int_]: ...
    @overload
    def tensordot(
        self: _spbase[_SubFloat], /, other: _JustND[float | int | bool], axes: _Axes = 2
    ) -> _ScalarOrDense[np.float64]: ...
    @overload
    def tensordot(
        self: _spbase[_SubComplex], /, other: _JustND[complex | float | int | bool], axes: _Axes = 2
    ) -> _ScalarOrDense[np.complex128]: ...
    @overload
    def tensordot(
        self: _spbase[_SupComplexT], /, other: _JustND[complex | float | int | bool], axes: _Axes = 2
    ) -> _ScalarOrDense[_SupComplexT]: ...
    @overload
    def tensordot(
        self: _spbase[_SupFloatT], /, other: _JustND[float | int | bool], axes: _Axes = 2
    ) -> _ScalarOrDense[_SupFloatT]: ...
    @overload
    def tensordot(self: _spbase[_SupIntT], /, other: _JustND[int | bool], axes: _Axes = 2) -> _ScalarOrDense[_SupIntT]: ...

class coo_array(_coo_base[_SCT, _ShapeT_co], sparray[_SCT, _ShapeT_co], Generic[_SCT, _ShapeT_co]): ...

class coo_matrix(_coo_base[_SCT, tuple[int | bool, int | bool]], spmatrix[_SCT], Generic[_SCT]):  # type: ignore[misc]
    @property
    @override
