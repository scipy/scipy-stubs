...
@overload
def convert_temperature(val: onp.ToFloatND, old_scale: _TempScale, new_scale: _TempScale) -> onp.ArrayND[np.float64 | Any]: ...
...
@overload
def lambda2nu(lambda_: onp.ToFloatND) -> onp.ArrayND[np.float64 | Any]: ...
...
@overload
def nu2lambda(nu: onp.ToFloatND) -> onp.ArrayND[np.float64 | Any]: ...
