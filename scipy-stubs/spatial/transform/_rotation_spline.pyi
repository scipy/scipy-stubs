...
def _angular_rate_to_rotvec_dot_matrix(rotvec: onp.Array2D[np.float64]) -> onp.Array3D[np.float64]: ...
def _rotvec_dot_to_angular_rate_matrix(rotvec_dot: onp.Array2D[np.float64]) -> onp.Array3D[np.float64]: ...
def _angular_acceleration_nonlinear_term(
    rotvec: onp.Array2D[np.float64], rotvec_dot: onp.Array2D[np.float64]
) -> onp.Array2D[np.float64]: ...
def _compute_angular_rate(rotvec: onp.Array2D[np.float64], rotvec_dot: onp.Array2D[np.float64]) -> onp.Array2D[np.float64]: ...
def _compute_angular_acceleration(
    rotvec: onp.Array2D[np.float64], rotvec_dot: onp.Array2D[np.float64], rotvecs_dot_dot: onp.Array2D[np.float64]
) -> onp.Array2D[np.float64]: ...
