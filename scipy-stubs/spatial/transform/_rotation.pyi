...
class Rotation:
    ...
    #
    def magnitude(self, /) -> float | int | bool | np.float64 | _Float1D: ...
    ...
    @classmethod
    def identity(cls, num: int | bool | None = None) -> Self: ...
    @classmethod
    def random(cls, num: int | bool | None = None, rng: ToRNG = None) -> Self: ...
    #
    @overload
    @classmethod
    def align_vectors(
    ...
    ) -> tuple[Self, float | int | bool, _Float2D]: ...
    @overload
    @classmethod
    def align_vectors(
        cls,
