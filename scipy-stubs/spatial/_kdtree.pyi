...
@overload
def minkowski_distance_p(x: onp.ToFloatND, y: onp.ToFloatND, p: int | bool = 2) -> onp.ArrayND[np.float64]: ...
@overload
def minkowski_distance_p(
    x: onp.ToComplexND, y: onp.ToComplexND, p: int | bool = 2
) -> onp.ArrayND[np.float64 | np.complex128]: ...

#
@overload
def minkowski_distance(x: onp.ToFloatND, y: onp.ToFloatND, p: int | bool = 2) -> onp.ArrayND[np.float64]: ...
@overload
def minkowski_distance(x: onp.ToComplexND, y: onp.ToComplexND, p: int | bool = 2) -> onp.ArrayND[np.float64 | np.complex128]: ...

#
@overload
def distance_matrix(
    x: onp.ToFloatND, y: onp.ToFloatND, p: int | bool = 2, threshold: int | bool = 1_000_000
