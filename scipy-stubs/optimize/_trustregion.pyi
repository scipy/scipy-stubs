...
class BaseQuadraticSubproblem:
    ...
    def __call__(self, /, p: onp.ToFloat1D) -> float | int | bool | np.float64: ...

    #
    @property
    def fun(self, /) -> float | int | bool | np.float64: ...
    @property
    def jac_mag(self, /) -> float | int | bool | np.float64: ...
    @property
    ...
    ) -> list[float | int | bool | np.float64]: ...  # list of size 2
