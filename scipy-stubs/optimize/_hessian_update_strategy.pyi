...
class HessianUpdateStrategy(Protocol):
    ...
    @overload
    def __matmul__(self, p: onp.ToComplex1D, /) -> onp.Array1D[np.float64] | onp.Array1D[np.complex128]: ...
    #
    @overload
    def dot(self, /, p: onp.ToFloat1D) -> onp.Array1D[np.float64]: ...
    @overload
    def dot(self, /, p: onp.ToComplex1D) -> onp.Array1D[np.float64] | onp.Array1D[np.complex128]: ...
    #
