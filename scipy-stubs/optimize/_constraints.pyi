...
class Bounds(_Constraint[_ShapeT_co, _ScalarT_co], Generic[_ShapeT_co, _ScalarT_co]):
    ...
    def residual(
        self: Bounds[Any, np.complex128 | np.clongdouble], /, x: onp.ToComplex128 | onp.ToComplex128_1D
    ) -> _Tuple2[onp.ArrayND[_ScalarT_co, _ShapeT_co]]: ...
...
class PreparedConstraint(_BaseConstraint[_ShapeT_co], Generic[_ShapeT_co]):
...
def old_bound_to_new(bounds: Iterable[_Tuple2[float]]) -> _Tuple2[onp.Array1D[np.float64]]: ...
def strict_bounds(
