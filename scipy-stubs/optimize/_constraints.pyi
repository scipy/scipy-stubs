...
def new_bounds_to_old(lb: onp.ToFloat1D, ub: onp.ToFloat1D, n: op.CanIndex) -> list[_Tuple2[float | int | bool]]: ...
def old_bound_to_new(bounds: Iterable[_Tuple2[float | int | bool]]) -> _Tuple2[_Vector]: ...
...
def old_constraint_to_new(ic: int | bool, con: _OldConstraint) -> NonlinearConstraint: ...
