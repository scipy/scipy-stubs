...
NUM_JAC_DIFF_REJECT: Final[float | int | bool] = ...
NUM_JAC_DIFF_SMALL: Final[float | int | bool] = ...
NUM_JAC_DIFF_BIG: Final[float | int | bool] = ...
NUM_JAC_MIN_FACTOR: Final[float | int | bool] = ...
NUM_JAC_FACTOR_INCREASE: Final[float | int | bool] = 10
NUM_JAC_FACTOR_DECREASE: Final[float | int | bool] = 0.1
...
class OdeSolution:
    ...
    @overload
    def __call__(self, /, t: float | int | bool | _ToFloat64) -> onp.Array1D[np.float64]: ...
    @overload
    ...
    @overload
    def __call__(self, /, t: complex | float | int | bool) -> onp.Array1D[np.float64 | np.complex128]: ...
    @overload
    def __call__(
        self, /, t: Sequence[float | int | bool | _ToFloat64] | onp.CanArrayND[_ToFloat64]
    ...
    @overload
    def __call__(self, /, t: Sequence[complex | float | int | bool]) -> onp.Array2D[np.float64 | np.complex128]: ...
...
def select_initial_step(
    ...
    t0: float | int | bool | np.float64,
    y0: onp.ArrayND[np.float64],
    t_bound: float | int | bool | np.float64,
    max_step: float | int | bool | np.float64,
    f0: onp.ArrayND[np.float64],
    direction: float | int | bool | np.float64,
    order: float | int | bool | np.float64,
    rtol: float | int | bool | np.float64,
    atol: float | int | bool | np.float64,
) -> float | int | bool | np.float64: ...
def num_jac(
    fun: Callable[[np.float64, onp.Array1D[np.float64]], onp.Array1D[np.float64]],
    t: float | int | bool | np.float64,
    y: onp.ArrayND[np.float64],
    f: onp.ArrayND[np.float64],
    threshold: float | int | bool | np.float64,
