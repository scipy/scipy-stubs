...
from typing import IO, Any, Final, Generic, Literal, LiteralString, Protocol, type_check_only
...
class VarReader4:
    ...
    def array_from_header[DTypeT: np.dtype[np.generic]](
        self, /, hdr: _SupportsVarHeader[DTypeT], process: bool = True
    ) -> np.ndarray[tuple[Any, ...], DTypeT] | coo_matrix: ...
    def read_sub_array[DTypeT: np.dtype[np.generic]](
        self, /, hdr: _SupportsVarHeader[DTypeT], copy: bool = True
    ) -> np.ndarray[tuple[Any, ...], DTypeT]: ...
    def read_full_array[DTypeT: np.dtype[np.generic]](
        self, /, hdr: _SupportsVarHeader[DTypeT]
    ) -> np.ndarray[tuple[Any, ...], DTypeT]: ...
    def read_char_array[DTypeT: np.dtype[np.generic]](
        self, /, hdr: _SupportsVarHeader[DTypeT]
    ) -> np.ndarray[tuple[Any, ...], DTypeT]: ...
...
class MatFile4Reader(MatFileReader):
    ...
    def read_var_array[DTypeT: np.dtype[np.generic]](
        self, /, header: _SupportsVarHeader[DTypeT], process: bool = True
    ) -> np.ndarray[tuple[Any, ...], DTypeT]: ...
