...
def _get_matfile_version(fileobj: IO[bytes]) -> tuple[Literal[1, 2], int | bool]: ...
...
def matfile_version(file_name: FileName, *, appendmat: bool = True) -> tuple[Literal[0, 1, 2], int | bool]: ...
def matdims(arr: onp.ArrayND, oned_as: Literal["column", "row"] = "column") -> onp.AtLeast1D: ...
def arr_dtype_number(arr: onp.HasDType[np.dtype[np.character]], num: int | bool | str) -> np.dtype[np.character]: ...
