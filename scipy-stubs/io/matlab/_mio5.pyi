...
class VarWriter5:
    ...
    def write_element(self, /, arr: onp.Array, mdtype: int | bool | None = None) -> None: ...
    def write_smalldata_element(self, /, arr: onp.Array, mdtype: int | bool, byte_count: int | bool) -> None: ...
    def write_regular_element(self, /, arr: onp.Array, mdtype: int | bool, byte_count: int | bool) -> None: ...
    def write_header(
        self,
        /,
        shape: AnyShape,
    ...
    def update_matrix_tag(self, /, start_pos: int | bool) -> None: ...
